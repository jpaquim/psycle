...
public:
	...
	\param useHandle : if true a handle is shown on the bottom right corner of the dialog
	*/
	CResizablePropertySheetImpl(ATL::_U_STRINGorID title = (LPCTSTR)NULL, UINT uStartPage = 0, HWND hWndParent = NULL, bool useHandle = true);
	//! Creates it
...
public:
	...
	*/
	CChildResizablePropertySheetImpl(UINT placeHolderID, ATL::_U_STRINGorID title = (LPCTSTR)NULL, UINT uStartPage = 0, HWND hWndParent = NULL, bool useHandle = true);
...
public:
	...
	\param placeHolderID : id of the control which will server as a reference for the position of the property sheet
	*/
	CPopupResizablePropertySheetImpl(ATL::_U_STRINGorID title = (LPCTSTR)NULL, UINT uStartPage = 0, HWND hWndParent = NULL, bool useHandle = true);
...
public:
	...
	//! Constructor
	CResizablePropertyPageImplT(ATL::_U_STRINGorID title = (LPCTSTR)NULL);
...
public:
	...
	//! Constructor
	CAxResizablePropertyPageImpl(ATL::_U_STRINGorID title = (LPCTSTR)NULL);
#if (_ATL_VER >= 0x0700)
...
inline CResizablePropertySheetImpl<childWnd, T, TBase>::CResizablePropertySheetImpl(ATL::_U_STRINGorID title , UINT uStartPage, HWND hWndParent, bool useHandle)
...
//=============================================================================
template <class T, class TBase>
CChildResizablePropertySheetImpl<T, TBase>::CChildResizablePropertySheetImpl(UINT placeHolderID, ATL::_U_STRINGorID title, UINT uStartPage, HWND hWndParent, bool useHandle)
...
//=============================================================================
template <class T, class TBase>
CPopupResizablePropertySheetImpl<T, TBase>::CPopupResizablePropertySheetImpl(ATL::_U_STRINGorID title, UINT uStartPage, HWND hWndParent, bool useHandle)
...
inline CResizablePropertyPageImplT<T, TBase, dialogBase>::CResizablePropertyPageImplT(ATL::_U_STRINGorID title)
...
//-----------------------------------------------------------------------------
template <class T, class TBase>
inline CResizablePropertyPageImpl<T, TBase>::CResizablePropertyPageImpl(ATL::_U_STRINGorID title)
: inherited(title)
{
}
...
//-----------------------------------------------------------------------------
template <class T, class TBase>
inline CAxResizablePropertyPageImpl<T, TBase>::CAxResizablePropertyPageImpl(ATL::_U_STRINGorID title)
: inherited(title)
{
}
