/** @file 
 *  @brief ExtRiff.cpp  -  Don Cross, April 1993.
...
DDCRET ExtRiffFile::Open ( const TCHAR *Filename, ExtRiffFileMode NewMode )
{
...
DDCRET ExtRiffFile::Backpatch ( long FileOffset,
                             const void *Data,
                             unsigned NumBytes )
{
   if ( !file ||
...
DDCRET WaveFile::OpenForRead ( const TCHAR *Filename )
{
...
DDCRET WaveFile::OpenForWrite ( const TCHAR  *Filename,
                                UINT32       SamplingRate,
