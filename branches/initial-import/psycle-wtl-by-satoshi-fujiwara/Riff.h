/** @file 
 *  @brief ExtRiff file format classes.
 *  @author Don Cross, April 1993.
...
public:
   ...
   DDCRET Open ( const TCHAR *Filename, ExtRiffFileMode NewMode );
...
public:
   ...
   DDCRET OpenForWrite ( const TCHAR  *Filename,
                         UINT32       SamplingRate   = 44100,
                         UINT16       BitsPerSample  =    16,
                         UINT16       NumChannels    =     2 );

   DDCRET OpenForRead ( const TCHAR *Filename );
