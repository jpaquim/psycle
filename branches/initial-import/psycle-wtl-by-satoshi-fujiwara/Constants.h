 ...
 *  $Revision: 1.5 $
 */
#define VERSION_NUMBER _T("20041020.Test")
...
const int KEY_PER_OCTAVE = 12;
const int SHARP_KEY_PER_OCTAVE = 5;
const int NATURAL_KEY_PER_OCTAVE = 7;
const int NATURAL_KEY = 1;
const int SHARP_KEY = 0;

#define DEFAULT_VOLUME 0xff
const unsigned char BLANK_EVENT[EVENT_SIZE]={255,255,255,0,0,0,0,0};
