...
/////////////////////////////////////////////////////////////////////////////
// CMidiInputDlg message handlers

int CMidiInputDlg::OnApply() 
{
...
LRESULT CMidiInputDlg::OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	
	// TODO: Add extra initialization here
	
	m_midiRecordVelButton.Attach(GetDlgItem(IDC_MIDI_RECORD_VEL));
	m_midiTypeVelComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_VEL));
	m_midiCommandVelEdit.Attach(GetDlgItem(IDC_MIDI_COMMAND_VEL));
	m_midiFromVelEdit.Attach(GetDlgItem(IDC_MIDI_FROM_VEL));
	m_midiToVelEdit.Attach(GetDlgItem(IDC_MIDI_TO_VEL));
	m_midiRecordPitButton.Attach(GetDlgItem(IDC_MIDI_RECORD_PIT));
	m_midiTypePitComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_PIT));
	m_midiCommandPitEdit.Attach(GetDlgItem(IDC_MIDI_COMMAND_PIT));
	m_midiFromPitEdit.Attach(GetDlgItem(IDC_MIDI_FROM_PIT));
	m_midiToPitEdit.Attach(GetDlgItem(IDC_MIDI_TO_PIT));
	m_midiRecord0Button.Attach(GetDlgItem(IDC_MIDI_RECORD_0));
	m_midiMessage0Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_0));
	m_midiType0ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_0));
	m_midiCommand0Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_0));
	m_midiFrom0Edit.Attach(GetDlgItem(IDC_MIDI_FROM_0));
	m_midiTo0Edit.Attach(GetDlgItem(IDC_MIDI_TO_0));
	m_midiRecord1Button.Attach(GetDlgItem(IDC_MIDI_RECORD_1));
	m_midiMessage1Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_1));
	m_midiType1ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_1));
	m_midiCommand1Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_1));
	m_midiFrom1Edit.Attach(GetDlgItem(IDC_MIDI_FROM_1));
	m_midiTo1Edit.Attach(GetDlgItem(IDC_MIDI_TO_1));
	m_midiRecord2Button.Attach(GetDlgItem(IDC_MIDI_RECORD_2));
	m_midiMessage2Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_2));
	m_midiType2ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_2));
	m_midiCommand2Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_2));
	m_midiFrom2Edit.Attach(GetDlgItem(IDC_MIDI_FROM_2));
	m_midiTo2Edit.Attach(GetDlgItem(IDC_MIDI_TO_2));
	m_midiRecord3Button.Attach(GetDlgItem(IDC_MIDI_RECORD_3));
	m_midiMessage3Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_3));
	m_midiType3ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_3));
	m_midiCommand3Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_3));
	m_midiFrom3Edit.Attach(GetDlgItem(IDC_MIDI_FROM_3));
	m_midiTo3Edit.Attach(GetDlgItem(IDC_MIDI_TO_3));
	m_midiRecord4Button.Attach(GetDlgItem(IDC_MIDI_RECORD_4));
	m_midiMessage4Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_4));
	m_midiType4ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_4));
	m_midiCommand4Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_4));
	m_midiFrom4Edit.Attach(GetDlgItem(IDC_MIDI_FROM_4));
	m_midiTo4Edit.Attach(GetDlgItem(IDC_MIDI_TO_4));
	m_midiRecord5Button.Attach(GetDlgItem(IDC_MIDI_RECORD_5));
	m_midiMessage5Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_5));
	m_midiType5ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_5));
	m_midiCommand5Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_5));
	m_midiFrom5Edit.Attach(GetDlgItem(IDC_MIDI_FROM_5));
	m_midiTo5Edit.Attach(GetDlgItem(IDC_MIDI_TO_5));
	m_midiRecord6Button.Attach(GetDlgItem(IDC_MIDI_RECORD_6));
	m_midiMessage6Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_6));
	m_midiType6ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_6));
	m_midiCommand6Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_6));
	m_midiFrom6Edit.Attach(GetDlgItem(IDC_MIDI_FROM_6));
	m_midiTo6Edit.Attach(GetDlgItem(IDC_MIDI_TO_6));
	m_midiRecord7Button.Attach(GetDlgItem(IDC_MIDI_RECORD_7));
	m_midiMessage7Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_7));
	m_midiType7ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_7));
	m_midiCommand7Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_7));
	m_midiFrom7Edit.Attach(GetDlgItem(IDC_MIDI_FROM_7));
	m_midiTo7Edit.Attach(GetDlgItem(IDC_MIDI_TO_7));
	m_midiRecord8Button.Attach(GetDlgItem(IDC_MIDI_RECORD_8));
	m_midiMessage8Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_8));
	m_midiType8ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_8));
	m_midiCommand8Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_8));
	m_midiFrom8Edit.Attach(GetDlgItem(IDC_MIDI_FROM_8));
	m_midiTo8Edit.Attach(GetDlgItem(IDC_MIDI_TO_8));
	m_midiRecord9Button.Attach(GetDlgItem(IDC_MIDI_RECORD_9));
	m_midiMessage9Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_9));
	m_midiType9ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_9));
	m_midiCommand9Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_9));
	m_midiFrom9Edit.Attach(GetDlgItem(IDC_MIDI_FROM_9));
	m_midiTo9Edit.Attach(GetDlgItem(IDC_MIDI_TO_9));
	m_midiRecord10Button.Attach(GetDlgItem(IDC_MIDI_RECORD_10));
	m_midiMessage10Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_10));
	m_midiType10ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_10));
	m_midiCommand10Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_10));
	m_midiFrom10Edit.Attach(GetDlgItem(IDC_MIDI_FROM_10));
	m_midiTo10Edit.Attach(GetDlgItem(IDC_MIDI_TO_10));
	m_midiRecord11Button.Attach(GetDlgItem(IDC_MIDI_RECORD_11));
	m_midiMessage11Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_11));
	m_midiType11ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_11));
	m_midiCommand11Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_11));
	m_midiFrom11Edit.Attach(GetDlgItem(IDC_MIDI_FROM_11));
	m_midiTo11Edit.Attach(GetDlgItem(IDC_MIDI_TO_11));
	m_midiRecord12Button.Attach(GetDlgItem(IDC_MIDI_RECORD_12));
	m_midiMessage12Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_12));
	m_midiType12ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_12));
	m_midiCommand12Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_12));
	m_midiFrom12Edit.Attach(GetDlgItem(IDC_MIDI_FROM_12));
	m_midiTo12Edit.Attach(GetDlgItem(IDC_MIDI_TO_12));
	m_midiRecord13Button.Attach(GetDlgItem(IDC_MIDI_RECORD_13));
	m_midiMessage13Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_13));
	m_midiType13ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_13));
	m_midiCommand13Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_13));
	m_midiFrom13Edit.Attach(GetDlgItem(IDC_MIDI_FROM_13));
	m_midiTo13Edit.Attach(GetDlgItem(IDC_MIDI_TO_13));
	m_midiRecord14Button.Attach(GetDlgItem(IDC_MIDI_RECORD_14));
	m_midiMessage14Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_14));
	m_midiType14ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_14));
	m_midiCommand14Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_14));
	m_midiFrom14Edit.Attach(GetDlgItem(IDC_MIDI_FROM_14));
	m_midiTo14Edit.Attach(GetDlgItem(IDC_MIDI_TO_14));
	m_midiRecord15Button.Attach(GetDlgItem(IDC_MIDI_RECORD_15));
	m_midiMessage15Edit.Attach(GetDlgItem(IDC_MIDI_MESSAGE_15));
	m_midiType15ComboBox.Attach(GetDlgItem(IDC_MIDI_TYPE_15));
	m_midiCommand15Edit.Attach(GetDlgItem(IDC_MIDI_COMMAND_15));
	m_midiFrom15Edit.Attach(GetDlgItem(IDC_MIDI_FROM_15));
	m_midiTo15Edit.Attach(GetDlgItem(IDC_MIDI_TO_15));
	...
	m_midiTypeVelComboBox.AddString(_T("cmd"));
	m_midiTypeVelComboBox.AddString(_T("ins"));
	m_midiTypeVelComboBox.SetCurSel(Global::pConfig->_midiTypeVel?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiCommandVel);
	m_midiCommandVelEdit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFromVel);
	m_midiFromVelEdit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiToVel);
	m_midiToVelEdit.SetWindowText(str);

	m_midiRecordPitButton.SetCheck(Global::pConfig->_midiRecordPit?1:0);
	m_midiTypePitComboBox.AddString(_T("cmd"));
	m_midiTypePitComboBox.AddString(_T("twk"));
	m_midiTypePitComboBox.AddString(_T("tws"));
	m_midiTypePitComboBox.AddString(_T("ins"));
	m_midiTypePitComboBox.AddString(_T("mcm"));
	m_midiTypePitComboBox.SetCurSel(Global::pConfig->_midiTypePit);
	str.Format(_T("%x"), Global::pConfig->_midiCommandPit);
	m_midiCommandPitEdit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFromPit);
	m_midiFromPitEdit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiToPit);
	m_midiToPitEdit.SetWindowText(str);

	m_midiRecord0Button.SetCheck(Global::pConfig->_midiRecord0?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage0);
	m_midiMessage0Edit.SetWindowText(str);
	m_midiType0ComboBox.AddString(_T("cmd"));
	m_midiType0ComboBox.AddString(_T("twk"));
	m_midiType0ComboBox.AddString(_T("tws"));
	m_midiType0ComboBox.AddString(_T("ins"));
	m_midiType0ComboBox.AddString(_T("mcm"));
	m_midiType0ComboBox.SetCurSel(Global::pConfig->_midiType0);
	str.Format(_T("%x"), Global::pConfig->_midiCommand0);
	m_midiCommand0Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom0);
	m_midiFrom0Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo0);
	m_midiTo0Edit.SetWindowText(str);

	m_midiRecord1Button.SetCheck(Global::pConfig->_midiRecord1?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage1);
	m_midiMessage1Edit.SetWindowText(str);
	m_midiType1ComboBox.AddString(_T("cmd"));
	m_midiType1ComboBox.AddString(_T("twk"));
	m_midiType1ComboBox.AddString(_T("tws"));
	m_midiType1ComboBox.AddString(_T("ins"));
	m_midiType1ComboBox.AddString(_T("mcm"));
	m_midiType1ComboBox.SetCurSel(Global::pConfig->_midiType1);
	str.Format(_T("%x"), Global::pConfig->_midiCommand1);
	m_midiCommand1Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom1);
	m_midiFrom1Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo1);
	m_midiTo1Edit.SetWindowText(str);

	m_midiRecord2Button.SetCheck(Global::pConfig->_midiRecord2?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage2);
	m_midiMessage2Edit.SetWindowText(str);
	m_midiType2ComboBox.AddString(_T("cmd"));
	m_midiType2ComboBox.AddString(_T("twk"));
	m_midiType2ComboBox.AddString(_T("tws"));
	m_midiType2ComboBox.AddString(_T("ins"));
	m_midiType2ComboBox.AddString(_T("mcm"));
	m_midiType2ComboBox.SetCurSel(Global::pConfig->_midiType2);
	str.Format(_T("%x"), Global::pConfig->_midiCommand2);
	m_midiCommand2Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom2);
	m_midiFrom2Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo2);
	m_midiTo2Edit.SetWindowText(str);

	m_midiRecord3Button.SetCheck(Global::pConfig->_midiRecord3?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage3);
	m_midiMessage3Edit.SetWindowText(str);
	m_midiType3ComboBox.AddString(_T("cmd"));
	m_midiType3ComboBox.AddString(_T("twk"));
	m_midiType3ComboBox.AddString(_T("tws"));
	m_midiType3ComboBox.AddString(_T("ins"));
	m_midiType3ComboBox.AddString(_T("mcm"));
	m_midiType3ComboBox.SetCurSel(Global::pConfig->_midiType3);
	str.Format(_T("%x"), Global::pConfig->_midiCommand3);
	m_midiCommand3Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom3);
	m_midiFrom3Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo3);
	m_midiTo3Edit.SetWindowText(str);

	m_midiRecord4Button.SetCheck(Global::pConfig->_midiRecord4?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage4);
	m_midiMessage4Edit.SetWindowText(str);
	m_midiType4ComboBox.AddString(_T("cmd"));
	m_midiType4ComboBox.AddString(_T("twk"));
	m_midiType4ComboBox.AddString(_T("tws"));
	m_midiType4ComboBox.AddString(_T("ins"));
	m_midiType4ComboBox.AddString(_T("mcm"));
	m_midiType4ComboBox.SetCurSel(Global::pConfig->_midiType4);
	str.Format(_T("%x"), Global::pConfig->_midiCommand4);
	m_midiCommand4Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom4);
	m_midiFrom4Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo4);
	m_midiTo4Edit.SetWindowText(str);

	m_midiRecord5Button.SetCheck(Global::pConfig->_midiRecord5?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage5);
	m_midiMessage5Edit.SetWindowText(str);
	m_midiType5ComboBox.AddString(_T("cmd"));
	m_midiType5ComboBox.AddString(_T("twk"));
	m_midiType5ComboBox.AddString(_T("tws"));
	m_midiType5ComboBox.AddString(_T("ins"));
	m_midiType5ComboBox.AddString(_T("mcm"));
	m_midiType5ComboBox.SetCurSel(Global::pConfig->_midiType5);
	str.Format(_T("%x"), Global::pConfig->_midiCommand5);
	m_midiCommand5Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom5);
	m_midiFrom5Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo5);
	m_midiTo5Edit.SetWindowText(str);

	m_midiRecord6Button.SetCheck(Global::pConfig->_midiRecord6?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage6);
	m_midiMessage6Edit.SetWindowText(str);
	m_midiType6ComboBox.AddString(_T("cmd"));
	m_midiType6ComboBox.AddString(_T("twk"));
	m_midiType6ComboBox.AddString(_T("tws"));
	m_midiType6ComboBox.AddString(_T("ins"));
	m_midiType6ComboBox.AddString(_T("mcm"));
	m_midiType6ComboBox.SetCurSel(Global::pConfig->_midiType6);
	str.Format(_T("%x"), Global::pConfig->_midiCommand6);
	m_midiCommand6Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom6);
	m_midiFrom6Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo6);
	m_midiTo6Edit.SetWindowText(str);

	m_midiRecord7Button.SetCheck(Global::pConfig->_midiRecord7?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage7);
	m_midiMessage7Edit.SetWindowText(str);
	m_midiType7ComboBox.AddString(_T("cmd"));
	m_midiType7ComboBox.AddString(_T("twk"));
	m_midiType7ComboBox.AddString(_T("tws"));
	m_midiType7ComboBox.AddString(_T("ins"));
	m_midiType7ComboBox.AddString(_T("mcm"));
	m_midiType7ComboBox.SetCurSel(Global::pConfig->_midiType7);
	str.Format(_T("%x"), Global::pConfig->_midiCommand7);
	m_midiCommand7Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom7);
	m_midiFrom7Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo7);
	m_midiTo7Edit.SetWindowText(str);

	m_midiRecord8Button.SetCheck(Global::pConfig->_midiRecord8?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage8);
	m_midiMessage8Edit.SetWindowText(str);
	m_midiType8ComboBox.AddString(_T("cmd"));
	m_midiType8ComboBox.AddString(_T("twk"));
	m_midiType8ComboBox.AddString(_T("tws"));
	m_midiType8ComboBox.AddString(_T("ins"));
	m_midiType8ComboBox.AddString(_T("mcm"));
	m_midiType8ComboBox.SetCurSel(Global::pConfig->_midiType8);
	str.Format(_T("%x"), Global::pConfig->_midiCommand8);
	m_midiCommand8Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom8);
	m_midiFrom8Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo8);
	m_midiTo8Edit.SetWindowText(str);

	m_midiRecord9Button.SetCheck(Global::pConfig->_midiRecord9?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage9);
	m_midiMessage9Edit.SetWindowText(str);
	m_midiType9ComboBox.AddString(_T("cmd"));
	m_midiType9ComboBox.AddString(_T("twk"));
	m_midiType9ComboBox.AddString(_T("tws"));
	m_midiType9ComboBox.AddString(_T("ins"));
	m_midiType9ComboBox.AddString(_T("mcm"));
	m_midiType9ComboBox.SetCurSel(Global::pConfig->_midiType9);
	str.Format(_T("%x"), Global::pConfig->_midiCommand9);
	m_midiCommand9Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom9);
	m_midiFrom9Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo9);
	m_midiTo9Edit.SetWindowText(str);

	m_midiRecord10Button.SetCheck(Global::pConfig->_midiRecord10?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage10);
	m_midiMessage10Edit.SetWindowText(str);
	m_midiType10ComboBox.AddString(_T("cmd"));
	m_midiType10ComboBox.AddString(_T("twk"));
	m_midiType10ComboBox.AddString(_T("tws"));
	m_midiType10ComboBox.AddString(_T("ins"));
	m_midiType10ComboBox.AddString(_T("mcm"));
	m_midiType10ComboBox.SetCurSel(Global::pConfig->_midiType10);
	str.Format(_T("%x"), Global::pConfig->_midiCommand10);
	m_midiCommand10Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom10);
	m_midiFrom10Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo10);
	m_midiTo10Edit.SetWindowText(str);

	m_midiRecord11Button.SetCheck(Global::pConfig->_midiRecord11?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage11);
	m_midiMessage11Edit.SetWindowText(str);
	m_midiType11ComboBox.AddString(_T("cmd"));
	m_midiType11ComboBox.AddString(_T("twk"));
	m_midiType11ComboBox.AddString(_T("tws"));
	m_midiType11ComboBox.AddString(_T("ins"));
	m_midiType11ComboBox.AddString(_T("mcm"));
	m_midiType11ComboBox.SetCurSel(Global::pConfig->_midiType11);
	str.Format(_T("%x"), Global::pConfig->_midiCommand11);
	m_midiCommand11Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom11);
	m_midiFrom11Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo11);
	m_midiTo11Edit.SetWindowText(str);

	m_midiRecord12Button.SetCheck(Global::pConfig->_midiRecord12?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage12);
	m_midiMessage12Edit.SetWindowText(str);
	m_midiType12ComboBox.AddString(_T("cmd"));
	m_midiType12ComboBox.AddString(_T("twk"));
	m_midiType12ComboBox.AddString(_T("tws"));
	m_midiType12ComboBox.AddString(_T("ins"));
	m_midiType12ComboBox.AddString(_T("mcm"));
	m_midiType12ComboBox.SetCurSel(Global::pConfig->_midiType12);
	str.Format(_T("%x"), Global::pConfig->_midiCommand12);
	m_midiCommand12Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom12);
	m_midiFrom12Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo12);
	m_midiTo12Edit.SetWindowText(str);

	m_midiRecord13Button.SetCheck(Global::pConfig->_midiRecord13?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage13);
	m_midiMessage13Edit.SetWindowText(str);
	m_midiType13ComboBox.AddString(_T("cmd"));
	m_midiType13ComboBox.AddString(_T("twk"));
	m_midiType13ComboBox.AddString(_T("tws"));
	m_midiType13ComboBox.AddString(_T("ins"));
	m_midiType13ComboBox.AddString(_T("mcm"));
	m_midiType13ComboBox.SetCurSel(Global::pConfig->_midiType13);
	str.Format(_T("%x"), Global::pConfig->_midiCommand13);
	m_midiCommand13Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom13);
	m_midiFrom13Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo13);
	m_midiTo13Edit.SetWindowText(str);

	m_midiRecord14Button.SetCheck(Global::pConfig->_midiRecord14?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage14);
	m_midiMessage14Edit.SetWindowText(str);
	m_midiType14ComboBox.AddString(_T("cmd"));
	m_midiType14ComboBox.AddString(_T("twk"));
	m_midiType14ComboBox.AddString(_T("tws"));
	m_midiType14ComboBox.AddString(_T("ins"));
	m_midiType14ComboBox.AddString(_T("mcm"));
	m_midiType14ComboBox.SetCurSel(Global::pConfig->_midiType14);
	str.Format(_T("%x"), Global::pConfig->_midiCommand14);
	m_midiCommand14Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom14);
	m_midiFrom14Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo14);
	m_midiTo14Edit.SetWindowText(str);

	m_midiRecord15Button.SetCheck(Global::pConfig->_midiRecord15?1:0);
	str.Format(_T("%x"), Global::pConfig->_midiMessage15);
	m_midiMessage15Edit.SetWindowText(str);
	m_midiType15ComboBox.AddString(_T("cmd"));
	m_midiType15ComboBox.AddString(_T("twk"));
	m_midiType15ComboBox.AddString(_T("tws"));
	m_midiType15ComboBox.AddString(_T("ins"));
	m_midiType15ComboBox.AddString(_T("mcm"));
	m_midiType15ComboBox.SetCurSel(Global::pConfig->_midiType15);
	str.Format(_T("%x"), Global::pConfig->_midiCommand15);
	m_midiCommand15Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiFrom15);
	m_midiFrom15Edit.SetWindowText(str);
	str.Format(_T("%x"), Global::pConfig->_midiTo15);
