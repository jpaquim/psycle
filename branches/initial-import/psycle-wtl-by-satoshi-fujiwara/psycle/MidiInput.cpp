	...
	m_syncing( false )
{
	...
	_tcscpy( m_config.versionStr, VERSION_STRING );
...
bool CMidiInput::Open( void )
{
	...
	if( !m_midiInHandlesTried && problem )
	{
		...
		messageText = SF::CResourceString(IDS_ERR_MSG0036);
		if( problem & 0x01 )
		{
			messageText += SF::CResourceString(IDS_ERR_MSG0037);
			errorCount++;
		}
		if( problem & 0x02 )
		{
			if( errorCount == 0 )
			{
				messageText += SF::CResourceString(IDS_ERR_MSG0038);//_T("MIDI sync device")
			}
			else
			{
				messageText += SF::CResourceString(IDS_ERR_MSG0039);//_T("and MIDI sync device");
			}
		}
		messageText += _T("?");
		...
		MessageBox( NULL,messageText,_T(""), MB_ICONEXCLAMATION+MB_OK );
	}
...
UINT CMidiInput::PopulateListbox( CComboBox * listbox )
{
	...
	listbox->AddString( SF::CResourceString(IDS_ERR_MSG0040));
		...
		case MIM_DATA:
		{
			...
			switch( statusHN )
			{
				...
				case 0x0C:
				{
					...
					{  
						if (Global::_pSong->pMachine( program ) )
						{
							// ok, map
			...
			if( !Global::_pSong->pMachine( busMachine ) && note != 254 )
			{
				return;
			}
	...
	switch( uMsg )
	{
		...
		case MIM_DATA:
		{
				...
				case 11:
					...
					if (Global::pConfig->_RecordTweaks)
					{
						if (Global::pConfig->_midiRecord0)
						{
							...
							{
								switch (Global::pConfig->_midiType0)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand0,
													Global::pConfig->_midiFrom0 + 
												(((Global::pConfig->_midiTo0 - Global::pConfig->_midiFrom0) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand0,
													Global::pConfig->_midiFrom0 + 
												(((Global::pConfig->_midiTo0 - Global::pConfig->_midiFrom0) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand0,
													Global::pConfig->_midiFrom0 + 
												(((Global::pConfig->_midiTo0 - Global::pConfig->_midiFrom0) * data2)/127));
									break;
								case 3:
									CMainFrame::GetInstance().m_view.MidiPatternMidiCommand(status,(data2<<8) | data1);
									break;
								case 4:
									CMainFrame::GetInstance().m_view.MidiPatternInstrument(
													Global::pConfig->_midiFrom0 + 
												(((Global::pConfig->_midiTo0 - Global::pConfig->_midiFrom0) * data2)/127));
									break;
								}
						...
						if (Global::pConfig->_midiRecord1)
						{
							...
							{
								switch (Global::pConfig->_midiType1)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand1,
													Global::pConfig->_midiFrom1 + 
												(((Global::pConfig->_midiTo1 - Global::pConfig->_midiFrom1) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand1,
													Global::pConfig->_midiFrom1 + 
												(((Global::pConfig->_midiTo1 - Global::pConfig->_midiFrom1) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand1,
													Global::pConfig->_midiFrom1 + 
												(((Global::pConfig->_midiTo1 - Global::pConfig->_midiFrom1) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord2)
						{
							...
							{
								switch (Global::pConfig->_midiType2)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand2,
													Global::pConfig->_midiFrom2 + 
												(((Global::pConfig->_midiTo2 - Global::pConfig->_midiFrom2) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand2,
													Global::pConfig->_midiFrom2 + 
												(((Global::pConfig->_midiTo2 - Global::pConfig->_midiFrom2) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand2,
													Global::pConfig->_midiFrom2 + 
												(((Global::pConfig->_midiTo2 - Global::pConfig->_midiFrom2) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord3)
						{
							...
							{
								switch (Global::pConfig->_midiType3)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand3,
													Global::pConfig->_midiFrom3 + 
												(((Global::pConfig->_midiTo3 - Global::pConfig->_midiFrom3) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand3,
													Global::pConfig->_midiFrom3 + 
												(((Global::pConfig->_midiTo3 - Global::pConfig->_midiFrom3) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand3,
													Global::pConfig->_midiFrom3 + 
												(((Global::pConfig->_midiTo3 - Global::pConfig->_midiFrom3) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord4)
						{
							...
							{
								switch (Global::pConfig->_midiType4)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand4,
													Global::pConfig->_midiFrom4 + 
												(((Global::pConfig->_midiTo4 - Global::pConfig->_midiFrom4) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand4,
													Global::pConfig->_midiFrom4 + 
												(((Global::pConfig->_midiTo4 - Global::pConfig->_midiFrom4) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand4,
													Global::pConfig->_midiFrom4 + 
												(((Global::pConfig->_midiTo4 - Global::pConfig->_midiFrom4) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord5)
						{
							...
							{
								switch (Global::pConfig->_midiType5)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand5,
													Global::pConfig->_midiFrom5 + 
												(((Global::pConfig->_midiTo5 - Global::pConfig->_midiFrom5) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand5,
													Global::pConfig->_midiFrom5 + 
												(((Global::pConfig->_midiTo5 - Global::pConfig->_midiFrom5) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand5,
													Global::pConfig->_midiFrom5 + 
												(((Global::pConfig->_midiTo5 - Global::pConfig->_midiFrom5) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord6)
						{
							...
							{
								switch (Global::pConfig->_midiType6)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand6,
													Global::pConfig->_midiFrom6 + 
												(((Global::pConfig->_midiTo6 - Global::pConfig->_midiFrom6) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand6,
													Global::pConfig->_midiFrom6 + 
												(((Global::pConfig->_midiTo6 - Global::pConfig->_midiFrom6) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand6,
													Global::pConfig->_midiFrom6 + 
												(((Global::pConfig->_midiTo6 - Global::pConfig->_midiFrom6) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord7)
						{
							...
							{
								switch (Global::pConfig->_midiType7)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand7,
													Global::pConfig->_midiFrom7 + 
												(((Global::pConfig->_midiTo7 - Global::pConfig->_midiFrom7) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand7,
													Global::pConfig->_midiFrom7 + 
												(((Global::pConfig->_midiTo7 - Global::pConfig->_midiFrom7) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand7,
													Global::pConfig->_midiFrom7 + 
												(((Global::pConfig->_midiTo7 - Global::pConfig->_midiFrom7) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord8)
						{
							...
							{
								switch (Global::pConfig->_midiType8)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand8,
													Global::pConfig->_midiFrom8 + 
												(((Global::pConfig->_midiTo8 - Global::pConfig->_midiFrom8) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand8,
													Global::pConfig->_midiFrom8 + 
												(((Global::pConfig->_midiTo8 - Global::pConfig->_midiFrom8) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand8,
													Global::pConfig->_midiFrom8 + 
												(((Global::pConfig->_midiTo8 - Global::pConfig->_midiFrom8) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord9)
						{
							...
							{
								switch (Global::pConfig->_midiType9)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand9,
													Global::pConfig->_midiFrom9 + 
												(((Global::pConfig->_midiTo9 - Global::pConfig->_midiFrom9) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand9,
													Global::pConfig->_midiFrom9 + 
												(((Global::pConfig->_midiTo9 - Global::pConfig->_midiFrom9) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand9,
													Global::pConfig->_midiFrom9 + 
												(((Global::pConfig->_midiTo9 - Global::pConfig->_midiFrom9) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord10)
						{
							...
							{
								switch (Global::pConfig->_midiType10)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand10,
													Global::pConfig->_midiFrom10 + 
												(((Global::pConfig->_midiTo10 - Global::pConfig->_midiFrom10) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand10,
													Global::pConfig->_midiFrom10 + 
												(((Global::pConfig->_midiTo10 - Global::pConfig->_midiFrom10) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand10,
													Global::pConfig->_midiFrom10 + 
												(((Global::pConfig->_midiTo10 - Global::pConfig->_midiFrom10) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord11)
						{
							...
							{
								switch (Global::pConfig->_midiType11)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand11,
													Global::pConfig->_midiFrom11 + 
												(((Global::pConfig->_midiTo11 - Global::pConfig->_midiFrom11) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand11,
													Global::pConfig->_midiFrom11 + 
												(((Global::pConfig->_midiTo11 - Global::pConfig->_midiFrom11) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand11,
													Global::pConfig->_midiFrom11 + 
												(((Global::pConfig->_midiTo11 - Global::pConfig->_midiFrom11) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord12)
						{
							...
							{
								switch (Global::pConfig->_midiType12)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand12,
													Global::pConfig->_midiFrom12 + 
												(((Global::pConfig->_midiTo12 - Global::pConfig->_midiFrom12) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand12,
													Global::pConfig->_midiFrom12 + 
												(((Global::pConfig->_midiTo12 - Global::pConfig->_midiFrom12) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand12,
													Global::pConfig->_midiFrom12 + 
												(((Global::pConfig->_midiTo12 - Global::pConfig->_midiFrom12) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord13)
						{
							...
							{
								switch (Global::pConfig->_midiType13)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand13,
													Global::pConfig->_midiFrom13 + 
												(((Global::pConfig->_midiTo13 - Global::pConfig->_midiFrom13) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand13,
													Global::pConfig->_midiFrom13 + 
												(((Global::pConfig->_midiTo13 - Global::pConfig->_midiFrom13) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand13,
													Global::pConfig->_midiFrom13 + 
												(((Global::pConfig->_midiTo13 - Global::pConfig->_midiFrom13) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord14)
						{
							...
							{
								switch (Global::pConfig->_midiType14)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand14,
													Global::pConfig->_midiFrom14 + 
												(((Global::pConfig->_midiTo14 - Global::pConfig->_midiFrom14) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand14,
													Global::pConfig->_midiFrom14 + 
												(((Global::pConfig->_midiTo14 - Global::pConfig->_midiFrom14) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand14,
													Global::pConfig->_midiFrom14 + 
												(((Global::pConfig->_midiTo14 - Global::pConfig->_midiFrom14) * data2)/127));
									break;
								case 3:
						...
						if (Global::pConfig->_midiRecord15)
						{
							...
							{
								switch (Global::pConfig->_midiType15)
								{
								case 0:
									CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommand15,
													Global::pConfig->_midiFrom15 + 
												(((Global::pConfig->_midiTo15 - Global::pConfig->_midiFrom15) * data2)/127));
									break;
								case 1:
									CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommand15,
													Global::pConfig->_midiFrom15 + 
												(((Global::pConfig->_midiTo15 - Global::pConfig->_midiFrom15) * data2)/127));
									break;
								case 2:
									CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommand15,
													Global::pConfig->_midiFrom15 + 
												(((Global::pConfig->_midiTo15 - Global::pConfig->_midiFrom15) * data2)/127));
									break;
								case 3:
				...
				case 14:
					...
					if (Global::pConfig->_RecordTweaks)
					{
						if (Global::pConfig->_midiRecordPit)
						{
							...
							{
							case 0:
								CMainFrame::GetInstance().m_view.MidiPatternCommand(Global::pConfig->_midiCommandPit,
												Global::pConfig->_midiFromPit + 
											(((Global::pConfig->_midiToPit - Global::pConfig->_midiFromPit) * data)/0x3fff));
								break;
							case 1:
								CMainFrame::GetInstance().m_view.MidiPatternTweak(Global::pConfig->_midiCommandPit,
												Global::pConfig->_midiFromPit + 
											(((Global::pConfig->_midiToPit - Global::pConfig->_midiFromPit) * data)/0x3fff));
								break;
							case 2:
								CMainFrame::GetInstance().m_view.MidiPatternTweakSlide(Global::pConfig->_midiCommandPit,
												Global::pConfig->_midiFromPit + 
											(((Global::pConfig->_midiToPit - Global::pConfig->_midiFromPit) * data)/0x3fff));
								break;
							case 3:
			...
			if( insertNote )
			{
				...
				CMainFrame::GetInstance().m_view.MidiPatternNote(note,noteOn);
			}
...
if( tstrobe == 0 )
{
	ATLTRACE( SF::CResourceString(IDS_TRACE_MSG0007), dwParam2, m_fixOffset, playPos );//"(0x%x) ms difference = %d playPos = %u (samples)\n\0"
}
tstrobe++;
...
#ifdef _DEBUGGING
// (DEBUGGING)
//_stprintf( tmp, _T("(0x%x) MIDI latency error %d (samples) samplebase = %u\n\0"), dwParam2, midiLatencySamples, m_adjustedPlayPos );
	ATLTRACE( SF::CResourceString(IDS_TRACE_MSG0008),dwParam2, midiLatencySamples, m_adjustedPlayPos );
#endif
}
...
bool CMidiInput::InjectMIDI( int amount )
{
	...
	if( !m_midiInHandle[ DRIVER_MIDI ] || 
		_tcscmp( Global::pConfig->_pOutputDriver->GetInfo()->_psName, SF::CResourceString(IDS_MSG0009) ) != 0 )	// TODO: need to remove this string compare? (speed)
	{
...
#ifdef _DEBUGGING
// (DEBUGGING)
ATLTRACE( tmp, _T("writePos %d (samples) syncAdjuster %d (samples) buffer %d (events)\n\0"), writePos, syncAdjuster, m_stats.bufferCount );
#endif
...
ATLTRACE( _T("*Lost Event*\n") );
	...
	do
	{
		...
		Plugin * pMachine = (Plugin*) Global::_pSong->pMachine( machine );
		...
		if( pMachine || note == 254 )
		{
			...
			switch( note )
			{
				...
				case 254:
				{
					// simulate a tracker _T('tick') (i.e. a line change for all machines)
					for (int tc=0; tc<MAX_MACHINES; tc++)
					{
						if( Global::_pSong->pMachine(tc))
						{
							Global::_pSong->pMachine(tc)->Tick();
						}
					}
	...
	//
	Global::_pSong->pMachine(MASTER_INDEX)->Work( amount );
	return true;
}
