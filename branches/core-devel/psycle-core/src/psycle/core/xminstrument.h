...
//  XMInstrument::WaveData Class declaration
		...
		public:
			...
			void Init(){
				...
				m_WaveLoopStart = 0;
				m_WaveLoopEnd = 0;
				m_WaveLoopType = LoopTypes::DO_NOT;
				m_WaveSusLoopStart = 0;
				m_WaveSusLoopEnd = 0;
				m_WaveSusLoopType = LoopTypes::DO_NOT;
			...
			const LoopTypes::loop_t WaveLoopType(){ return m_WaveLoopType;}
			void WaveLoopType(const LoopTypes::loop_t value){ m_WaveLoopType = value;}
			...
			const LoopTypes::loop_t WaveSusLoopType(){ return m_WaveSusLoopType;}
			void WaveSusLoopType(const LoopTypes::loop_t value){ m_WaveSusLoopType = value;}
		...
		private:
			...
			LoopTypes::loop_t m_WaveLoopType;
			std::uint32_t m_WaveSusLoopStart;
			std::uint32_t m_WaveSusLoopEnd;
			LoopTypes::loop_t m_WaveSusLoopType;
...
//  XMInstrument Class declaration
		...
		const NewNoteActions::nna_t NNA() { return m_NNA;}
		void NNA(const NewNoteActions::nna_t value){ m_NNA = value;}
		const DCTypes::dc_t DCT() { return m_DCT;}
		void DCT(const DCTypes::dc_t value){ m_DCT = value;}
		const NewNoteActions::nna_t DCA() { return m_DCA;}
		void DCA(const NewNoteActions::nna_t value){ m_DCA = value;}
