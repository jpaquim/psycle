...
// copyright 2000-2007 psycle development team http://psycle.sourceforge.net
...
namespace psycle { namespace helpers { namespace math {
	...
	float inline UNIVERSALIS__COMPILER__CONST fast_log2(float f) {
		...
		BOOST_AUTO_TEST_CASE(fast_log2_correctness_test) {
			...
			for(int i(0); i < sizeof input_values / sizeof *input_values; ++i) {
				...
				double const ratio = fast_log2(f) / (
					#if defined DIVERSALIS__COMPILER__MICROSOFT // lacks log2
		...
		BOOST_AUTO_TEST_CASE(fast_log2_speed_test) {
