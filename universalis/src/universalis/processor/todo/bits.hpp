...
/// inputs big endian ordered data, converting to processor internal ordering format.
/// \todo what about sign format?
template<typename Processor_Format>
inline std::istream & operator>>(std::istream & istream, serializable<Processor_Format> & serializable) {
		Processor_Format big_endian;
		istream >> big_endian;
		#if defined PROCESSOR__ENDIAN__BIG
...
/// \todo what about sign format?
template<typename Processor_Format>
inline std::ostream & operator<<(std::ostream & ostream, const serializable<Processor_Format> & serializable) {
	#if defined PROCESSOR__ENDIAN__BIG
