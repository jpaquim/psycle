...
namespace ngrs {
  ...
  void Segment7::paint( Graphics& g )
  {
  ...
  void Segment7::drawVerticalSegment( Graphics& g, int x , int y ,int  x1 , int y1, bool on )
  {
    if (on) 
  ...
  void Segment7::drawHorizontalSegment( Graphics& g, int x, int y, int x1, int y1, bool on )
  {
    if (on) 
      g.setForeground( onColor );
    else 
  ...
  void Segment7::setSeg( bool seg1, bool seg2, bool seg3, bool seg4, bool seg5, bool seg6, bool seg7 )
  {
    seg1_ = seg1;
    seg2_ = seg1;
    seg3_ = seg1;
  ...
  void Segment7::resetSeg( )
  {
    seg1_=seg2_=seg3_=seg4_=seg5_=seg6_=seg7_=false;
  }

  void Segment7::setColors( const Color & on, const Color & off )
  {
    onColor  = on;
    offColor = off;
  }
