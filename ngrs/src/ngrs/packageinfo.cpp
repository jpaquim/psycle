...
namespace ngrs {
  ...
  std::vector< std::string > PackageInfo::categories( ) const
  {
  ...
  std::vector< std::string > PackageInfo::factoryNamesByCategory( const std::string & categoryName ) const
  {
  ...
  std::string PackageInfo::name( ) const
  {
    return packageName;
  }
...
extern "C" ngrs::PackageInfo* createPackageInfo() {
  return new ngrs::PackageInfo();
}

extern "C" void destroyPackageInfo( ngrs::PackageInfo* p ) {
  delete p;
}
