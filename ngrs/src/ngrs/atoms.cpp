...
namespace ngrs {
  ...
  Atom Atoms::wm_delete_window( ) const
  {
    return wm_delete_window_;
  }

  Atom Atoms::wm_motif_hint( ) const
  {
    return wm_motif_hint_;
  }

  Atom Atoms::net_wm_state( ) const
  {
    return net_wm_state_;
  }

  Atom Atoms::net_wm_state_above( ) const
  {
    return net_wm_state_above_;
  }

  Atom Atoms::net_wm_state_stays_on_top( ) const
  {
    return net_wm_state_stays_on_top_;
  }

  Atom Atoms::net_wm_state_modal( ) const
  {
    return net_wm_state_modal_;
  }

  Atom Atoms::primary_sel( ) const
  {
    return primary_sel_;
  }

  Atom Atoms::targets( ) const
  {
    return targets_;
  }
