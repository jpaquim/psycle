...
int oscwaves[] =
{
	...
	WF_BLSAWTOOTH,
	WF_BLPARABOLA,
	WF_BLSAWTOOTH,	//	Vowel-A
	WF_BLSAWTOOTH,	//	Vowel-E
	WF_BLSAWTOOTH,	//	Vowel-I
	WF_BLSAWTOOTH,	//	Vowel-O
	WF_BLSAWTOOTH	//	Vowel-U
...
CMachineParameter const param_osc1_wave =
{
	"OSC 1 - Wave",
	"OSC 1 - Wave",
	1,
...
CMachineParameter const param_osc1_phase =
{
	"OSC 1 - Phase",
	"OSC 1 - Phase",
	0,
...
CMachineParameter const param_osc1_semi =
{
	"OSC 1 - Semi",
	"OSC 1 - Semi",
	-120,
...
CMachineParameter const param_osc1_cent =
{
	"OSC 1 - Cent",
	"OSC 1 - Cent",
	-64,
...
CMachineParameter const param_osc1_pm_type =
{
	"OSC 1 - PM.Type",
	"OSC 1 - PM.Type",
	0,
...
CMachineParameter const param_osc1_pm_amount =
{
	"OSC 1 - PM.Amount",
	"OSC 1 - PM.Amount",
	0,
...
CMachineParameter const param_osc1_kbd_track =
{
	"OSC 1 - Kbd.Track",
	"OSC 1 - Kbd.Track",
	0,
...
CMachineParameter const param_osc2_wave =
{
	"OSC 2 - Wave",
	"OSC 2 - Wave",
	0,
...
CMachineParameter const param_osc2_phase =
{
	"OSC 2 - Phase",
	"OSC 2 - Phase",
	0,
...
CMachineParameter const param_osc2_semi =
{
	"OSC 2 - Semi",
	"OSC 2 - Semi",
	-120,
...
CMachineParameter const param_osc2_cent =
{
	"OSC 2 - Cent",
	"OSC 2 - Cent",
	-64,
...
CMachineParameter const param_osc2_pm_type =
{
	"OSC 2 - PM.Type",
	"OSC 2 - PM.Type",
	0,
...
CMachineParameter const param_osc2_pm_amount =
{
	"OSC 2 - PM.Amount",
	"OSC 2 - PM.Amount",
	0,
...
CMachineParameter const param_osc2_kbd_track =
{
	"OSC 2 - Kbd.Track",
	"OSC 2 - Kbd.Track",
	0,
...
CMachineParameter const param_osc_phase_rand =
{
	"OSC - Phase rnd.",
	"OSC - Phase rnd.",
	0,
...
CMachineParameter const param_osc_fm =
{
	"OSC - FM",
	"OSC - FM",
	0,
...
CMachineParameter const param_osc_pm =
{
	"OSC - PM",
	"OSC - PM",
	0,
...
CMachineParameter const param_osc_mix =
{
	"OSC - Mix",
	"OSC - Mix",
	0,
...
CMachineParameter const param_osc_ring_mod =
{
	"OSC - Ring mod",
	"OSC - Ring mod",
	0,
...
CMachineParameter const param_noise_decay =
{
	"NOISE - Decay",
	"NOISE - Decay",
	0,
...
CMachineParameter const param_noise_color =
{
	"NOISE - Color",
	"NOISE - Color",
	0,
...
CMachineParameter const param_noise_level =
{
	"NOISE - Level",
	"NOISE - Level",
	0,
...
CMachineParameter const param_mod_delay =
{
	"MOD - Delay",
	"MOD - Delay",
	0,
...
CMachineParameter const param_mod_attack =
{
	"MOD - Attack",
	"MOD - Attack",
	0,
...
CMachineParameter const param_mod_decay =
{
	"MOD - Decay",
	"MOD - Decay",
	0,
...
CMachineParameter const param_mod_sustain =
{
	"MOD - Sustain",
	"MOD - Sustain",
	0,
...
CMachineParameter const param_mod_length =
{
	"MOD - Length",
	"MOD - Length",
	-1,
...
CMachineParameter const param_mod_release =
{
	"MOD - Release",
	"MOD - Release",
	0,
...
CMachineParameter const param_mod_amount =
{
	"MOD - Amount",
	"MOD - Amount",
	-256,
...
CMachineParameter const param_mod_dest =
{
	"MOD - Dest.",
	"MOD - Dest.",
	0,
...
CMachineParameter const param_lfo1_wave =
{
	"LFO 1 - Wave",
	"LFO 1 - Wave",
	0,
...
CMachineParameter const param_lfo1_rate =
{
	"LFO 1 - Rate",
	"LFO 1 - Rate",
	0,
...
CMachineParameter const param_lfo1_amount =
{
	"LFO 1 - Amount",
	"LFO 1 - Amount",
	-256,
...
CMachineParameter const param_lfo1_dest =
{
	"LFO 1 - Dest.",
	"LFO 1 - Dest.",
	0,
...
CMachineParameter const param_lfo2_delay =
{
	"LFO 2 - Delay",
	"LFO 2 - Delay",
	0,
...
CMachineParameter const param_lfo2_rate =
{
	"LFO 2 - Rate",
	"LFO 2 - Rate",
	0,
...
CMachineParameter const param_lfo2_amount =
{
	"LFO 2 - Amount",
	"LFO 2 - Amount",
	-256,
...
CMachineParameter const param_lfo2_dest =
{
	"LFO 2 - Dest.",
	"LFO 2 - Dest.",
	0,
...
CMachineParameter const param_vcf_delay =
{
	"VCF - Delay",
	"VCF - Delay",
	0,
...
CMachineParameter const param_vcf_attack =
{
	"VCF - Attack",
	"VCF - Attack",
	0,
...
CMachineParameter const param_vcf_decay =
{
	"VCF - Decay",
	"VCF - Decay",
	0,
...
CMachineParameter const param_vcf_sustain =
{
	"VCF - Sustain",
	"VCF - Sustain",
	0,
...
CMachineParameter const param_vcf_length =
{
	"VCF - Length",
	"VCF - Length",
	-1,
...
CMachineParameter const param_vcf_release =
{
	"VCF - Release",
	"VCF - Release",
	0,
...
CMachineParameter const param_vcf_amount =
{
	"VCF - Amount",
	"VCF - Amount",
	-256,
...
CMachineParameter const param_flt1_type =
{
	"FLT 1 - Type",
	"FLT 1 - Type",
	0,
...
CMachineParameter const param_flt1_freq =
{
	"FLT 1 - Freq.",
	"FLT 1 - Freq.",
	0,
...
CMachineParameter const param_flt1_q =
{
	"FLT 1 - Q",
	"FLT 1 - Q",
	0,
...
CMachineParameter const param_flt1_kbd_track =
{
	"FLT 1 - Kbd.Track",
	"FLT 1 - Kbd.Track",
	0,
...
CMachineParameter const param_flt2_mode =
{
	"FLT 2 - Mode",
	"FLT 2 - Mode",
	0,
...
CMachineParameter const param_flt2_freq =
{
	"FLT 2 - Freq.",
	"FLT 2 - Freq.",
	0,
...
CMachineParameter const param_flt2_q =
{
	"FLT 2 - Q",
	"FLT 2 - Q",
	0,
...
CMachineParameter const param_vca_attack =
{
	"VCA - Attack",
	"VCA - Attack",
	0,
...
CMachineParameter const param_vca_decay =
{
	"VCA - Decay",
	"VCA - Decay",
	0,
...
CMachineParameter const param_vca_sustain =
{
	"VCA - Sustain",
	"VCA - Sustain",
	0,
...
CMachineParameter const param_vca_length =
{
	"VCA - Length",
	"VCA - Length",
	-1,
...
CMachineParameter const param_vca_release =
{
	"VCA - Release",
	"VCA - Release",
	0,
...
CMachineParameter const param_amp_level =
{
	"AMP - Level",
	"AMP - Level",
	0,
...
CMachineParameter const param_glide =
{
	"Glide",
	"Glide",
	0,
...
CMachineParameter const param_inertia =
{
	"Inertia",
	"Inertia",
	0,
...
private:
	...
	// Instance Generic
	Globals m_globals;
	Voice m_voices[MAX_TRACKS][MAX_VOICES];
...
void mi::ParameterTweak(int par, int val)
{
	...
	case PARAM_LFO1_RATE :
		m_globals.m_lfo1_incr.SetTarget((float) val * WAVESIZE / 256.0f / 2205.0f);
		break;
	...
	case PARAM_LFO2_RATE :
		m_globals.m_lfo2_incr.SetTarget((float) val * WAVEFSIZE / 256.0f / 2205.0f);
		break;
	...
	case PARAM_FLT1_FREQ :
		m_globals.m_flt1_freq.SetTarget((float) val / 256.0f);
		break;
	case PARAM_FLT1_Q :
	...
	case PARAM_FLT2_FREQ :
		m_globals.m_flt2_freq.SetTarget((float) val / 256.0f);
		break;
	case PARAM_FLT2_Q :
	...
	case PARAM_INERTIA :
		...
		tmp = millis2samples(m_globals.m_inertia, pCB->GetSamplingRate());
...
bool mi::DescribeValue(char* txt,int const param, int const value)
{
	...
	case PARAM_OSC2_WAVE :
		...
		{
			wf.Get(oscwaves[value]);
			sprintf(txt, "%s", wf.Get()->pname);
		}
		return true;
	case PARAM_LFO1_WAVE :
		wf.Get(lfowaves[value]);
		sprintf(txt, "%s", wf.Get()->pname);
		return true;
	case PARAM_OSC1_PHASE :
	case PARAM_OSC2_PHASE :
	...
	case PARAM_OSC2_SEMI :
		tmp = value / 12;
		sprintf(txt, "%d.%d", tmp, value - tmp * 12);
		return true;
	case PARAM_OSC1_CENT :
	case PARAM_OSC2_CENT :
	case PARAM_MOD_AMOUNT :
	...
	case PARAM_VCA_RELEASE :
	case PARAM_INERTIA :
		sprintf(txt, "%.2f ms", (float) value * 4.0f);
		return true;
	case PARAM_GLIDE :
	...
	case PARAM_FLT1_FREQ :
	case PARAM_FLT2_FREQ :
		sprintf(txt, "%.2f Hz", (float) value * (float) pCB->GetSamplingRate() / 512.0f);
		return true;
	}
	return false;
}
...
{
	if (m_nvoices[track] == MAX_VOICES)
	{
		for (int i = 1; i < MAX_VOICES; i++)
			m_voices[track][i - 1] = m_voices[track][i];
		m_nvoices[track]--;
//		m_voices[track][m_nvoices[track]].Reset();
//		m_voices[track][0].Stop(millis2samples(10, m_globals.m_samplerate));
	}
...
void mi::Work(float *psamplesleft, float *psamplesright, int numsamples, int numtracks)
{
	...
	for (int t = 0; t < numtracks; t++)
	{
		...
		for (int v = nvoices - 1; v >= 0; v--)
		{
			...
			{
				m_voices[t][v].Work(m_out, numsamples);
			}
		}
		m_nvoices[t] = nvoices;
	}
