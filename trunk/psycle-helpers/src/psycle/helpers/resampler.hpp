...
using namespace universalis::stdlib;
	...
	/// sample interpolator kinds.
			...
			virtual void * GetResamplerData(double speed) const = 0;
	...
	class cubic_resampler : public resampler {
		...
		public:
			...
			/*override*/ void * GetResamplerData(double speed) const;
		...
		protected:
			...
			static float sinc_filtered(int16_t const * data, uint64_t offset, uint32_t res, uint64_t length, sinc_data_t* resampler_data);
...
#endif
			//Table to use in the filter-based sinc resampling.
