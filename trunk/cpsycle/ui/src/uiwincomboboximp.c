...
static void dev_setbackgroundcolor(psy_ui_win_ComboBoxImp* self, psy_ui_Color color) { self->win_component_imp.imp.vtable->dev_setbackgroundcolor(&self->win_component_imp.imp, color); }
