...
static void dev_dispose(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_dispose(&self->xt_component_imp.imp); }
static void dev_destroy(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_destroy(&self->xt_component_imp.imp); }
static void dev_show(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_show(&self->xt_component_imp.imp); }
static void dev_showstate(psy_ui_xt_ComboBoxImp* self, int state) { self->xt_component_imp.imp.vtable->dev_showstate(&self->xt_component_imp.imp, state); }
...
static psy_ui_Size dev_size(psy_ui_xt_ComboBoxImp* self) { return self->xt_component_imp.imp.vtable->dev_size(&self->xt_component_imp.imp); }
static psy_ui_Size dev_framesize(psy_ui_xt_ComboBoxImp* self) { return self->xt_component_imp.imp.vtable->dev_framesize(&self->xt_component_imp.imp); }
static void dev_scrollto(psy_ui_xt_ComboBoxImp* self, intptr_t dx, intptr_t dy) { self->xt_component_imp.imp.vtable->dev_scrollto(&self->xt_component_imp.imp, dx, dy); }
static psy_ui_Component* dev_parent(psy_ui_xt_ComboBoxImp* self) { return self->xt_component_imp.imp.vtable->dev_parent(&self->xt_component_imp.imp); }
static void dev_capture(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_capture(&self->xt_component_imp.imp); }
static void dev_releasecapture(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_releasecapture(&self->xt_component_imp.imp); }
static void dev_invalidate(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_invalidate(&self->xt_component_imp.imp); }
static void dev_invalidaterect(psy_ui_xt_ComboBoxImp* self, const psy_ui_Rectangle* r) { self->xt_component_imp.imp.vtable->dev_invalidaterect(&self->xt_component_imp.imp, r); }
static void dev_update(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_update(&self->xt_component_imp.imp); }
static void dev_setfont(psy_ui_xt_ComboBoxImp* self, psy_ui_Font* font) { self->xt_component_imp.imp.vtable->dev_setfont(&self->xt_component_imp.imp, font); }
static void dev_showhorizontalscrollbar(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_showhorizontalscrollbar(&self->xt_component_imp.imp); }
static void dev_hidehorizontalscrollbar(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_hidehorizontalscrollbar(&self->xt_component_imp.imp); }
static void dev_sethorizontalscrollrange(psy_ui_xt_ComboBoxImp* self, int min, int max) { self->xt_component_imp.imp.vtable->dev_sethorizontalscrollrange(&self->xt_component_imp.imp, min, max); }
static void dev_horizontalscrollrange(psy_ui_xt_ComboBoxImp* self, int* scrollmin, int* scrollmax) { self->xt_component_imp.imp.vtable->dev_horizontalscrollrange(&self->xt_component_imp.imp, scrollmin, scrollmax); }
static int dev_horizontalscrollposition(psy_ui_xt_ComboBoxImp* self) { return self->xt_component_imp.imp.vtable->dev_horizontalscrollposition(&self->xt_component_imp.imp); }
static void dev_sethorizontalscrollposition(psy_ui_xt_ComboBoxImp* self, int position) { self->xt_component_imp.imp.vtable->dev_sethorizontalscrollposition(&self->xt_component_imp.imp, position); }
static void dev_showverticalscrollbar(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_showverticalscrollbar(&self->xt_component_imp.imp); }
static void dev_hideverticalscrollbar(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_hideverticalscrollbar(&self->xt_component_imp.imp); }
static void dev_setverticalscrollrange(psy_ui_xt_ComboBoxImp* self, int min, int max) { self->xt_component_imp.imp.vtable->dev_setverticalscrollrange(&self->xt_component_imp.imp, min, max); }
static void dev_verticalscrollrange(psy_ui_xt_ComboBoxImp* self, int* scrollmin, int* scrollmax) { self->xt_component_imp.imp.vtable->dev_verticalscrollrange(&self->xt_component_imp.imp, scrollmin, scrollmax); }
static int dev_verticalscrollposition(psy_ui_xt_ComboBoxImp* self) { return self->xt_component_imp.imp.vtable->dev_verticalscrollposition(&self->xt_component_imp.imp); }
static void dev_setverticalscrollposition(psy_ui_xt_ComboBoxImp* self, int position) { self->xt_component_imp.imp.vtable->dev_setverticalscrollposition(&self->xt_component_imp.imp, position); }
static psy_List* dev_children(psy_ui_xt_ComboBoxImp* self, int recursive) { return self->xt_component_imp.imp.vtable->dev_children(&self->xt_component_imp.imp, recursive); }
static void dev_enableinput(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_enableinput(&self->xt_component_imp.imp); }
static void dev_preventinput(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_preventinput(&self->xt_component_imp.imp); }
static void dev_setcursor(psy_ui_xt_ComboBoxImp* self, psy_ui_CursorStyle style) { self->xt_component_imp.imp.vtable->dev_setcursor(&self->xt_component_imp.imp, style); }
static void dev_starttimer(psy_ui_xt_ComboBoxImp* self, unsigned int id, unsigned int interval) { self->xt_component_imp.imp.vtable->dev_starttimer(&self->xt_component_imp.imp, id, interval); }
static void dev_stoptimer(psy_ui_xt_ComboBoxImp* self, unsigned int id) { self->xt_component_imp.imp.vtable->dev_stoptimer(&self->xt_component_imp.imp, id); }
static void dev_seticonressource(psy_ui_xt_ComboBoxImp* self, int ressourceid) { self->xt_component_imp.imp.vtable->dev_seticonressource(&self->xt_component_imp.imp, ressourceid); }
static psy_ui_TextMetric dev_textmetric(psy_ui_xt_ComboBoxImp* self, psy_ui_Font* font) { return self->xt_component_imp.imp.vtable->dev_textmetric(&self->xt_component_imp.imp, font); }
static psy_ui_Size dev_textsize(psy_ui_xt_ComboBoxImp* self, const char* text, psy_ui_Font* font) { return self->xt_component_imp.imp.vtable->dev_textsize(&self->xt_component_imp.imp, text, font); }
static void dev_setbackgroundcolor(psy_ui_xt_ComboBoxImp* self, uint32_t color) { self->xt_component_imp.imp.vtable->dev_setbackgroundcolor(&self->xt_component_imp.imp, color); }
static void dev_settitle(psy_ui_xt_ComboBoxImp* self, const char* title) { self->xt_component_imp.imp.vtable->dev_settitle(&self->xt_component_imp.imp, title); }
static void dev_setfocus(psy_ui_xt_ComboBoxImp* self) { self->xt_component_imp.imp.vtable->dev_setfocus(&self->xt_component_imp.imp); }
static int dev_hasfocus(psy_ui_xt_ComboBoxImp* self) { return self->xt_component_imp.imp.vtable->dev_hasfocus(&self->xt_component_imp.imp); }
static void* dev_platform(psy_ui_xt_ComboBoxImp* self) { return (void*)&self->xt_component_imp; }
...
static int dev_addtext(psy_ui_xt_ComboBoxImp*, const char* text);
static void dev_settext(psy_ui_xt_ComboBoxImp*, const char* text, intptr_t index);
static void dev_text(psy_ui_xt_ComboBoxImp*, char* text);
static void dev_setstyle(psy_ui_xt_ComboBoxImp*, int style);
static void dev_clear(psy_ui_xt_ComboBoxImp*);
static void dev_setcursel(psy_ui_xt_ComboBoxImp*, intptr_t index);
static intptr_t dev_cursel(psy_ui_xt_ComboBoxImp*);
static void dev_selitems(psy_ui_xt_ComboBoxImp*, int* items, int maxitems);
static intptr_t dev_selcount(psy_ui_xt_ComboBoxImp*);
static intptr_t dev_count(psy_ui_xt_ComboBoxImp*);
static void dev_showdropdown(psy_ui_xt_ComboBoxImp*);

static psy_ui_ComboBoxImpVTable comboboximp_vtable;
static int comboboximp_vtable_initialized = 0;

static void comboboximp_imp_vtable_init(psy_ui_xt_ComboBoxImp* self)
{
...
{
	return (psy_ui_xt_ComboBoxImp*)malloc(sizeof(psy_ui_xt_ComboBoxImp));
}
	...
	psy_ui_ComponentImp* parent)
{
	...
	rv = psy_ui_xt_comboboximp_alloc();
	if (rv) {
		psy_ui_xt_comboboximp_init(rv, component, parent);
	}
	return rv;
}

int dev_addtext(psy_ui_xt_ComboBoxImp* self, const char* text)
{
//	return SendMessage(self->xt_combo_imp.hwnd, CB_ADDSTRING, 0, (LPARAM)text);
}

void dev_settext(psy_ui_xt_ComboBoxImp* self, const char* text, intptr_t index)
{
	//intptr_t sel;
...
void dev_setstyle(psy_ui_xt_ComboBoxImp* self, int style)
{
//#if defined(_WIN64)
...
void dev_text(psy_ui_xt_ComboBoxImp* self, char* text)
{
	//intptr_t sel;
...
void dev_clear(psy_ui_xt_ComboBoxImp* self)
{
	//SendMessage(self->xt_combo_imp.hwnd, CB_RESETCONTENT, 0, (LPARAM)0);
}

void dev_setcursel(psy_ui_xt_ComboBoxImp* self, intptr_t index)
{
	//char text[512];
	//intptr_t len;
...
intptr_t dev_cursel(psy_ui_xt_ComboBoxImp* self)
{
	//return SendMessage(self->xt_combo_imp.hwnd, CB_GETCURSEL, (WPARAM) 0, (LPARAM) 0);
	return 0;
}

intptr_t dev_count(psy_ui_xt_ComboBoxImp* self)
{
//	return SendMessage(self->xt_combo_imp.hwnd, CB_GETCOUNT, 0, (LPARAM) 0);
	return 0;
}

void dev_selitems(psy_ui_xt_ComboBoxImp* self, int* items, int maxitems)
{
	//SendMessage(self->xt_combo_imp.hwnd, CB_GETSELITEMS, (WPARAM)maxitems,
	//	(LPARAM)items);
}

intptr_t dev_selcount(psy_ui_xt_ComboBoxImp* self)
{
	return 0;
}
...
void dev_showdropdown(psy_ui_xt_ComboBoxImp* self)
{
	//psy_ui_Size size;
