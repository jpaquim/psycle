...
// VTable Prototypes
static void psy_ui_xt_font_imp_dispose(psy_ui_xt_FontImp*);
static void psy_ui_xt_font_imp_copy(psy_ui_xt_FontImp*, psy_ui_xt_FontImp* other);
static psy_ui_FontInfo dev_fontinfo(psy_ui_xt_FontImp*);
...
static void imp_vtable_init(psy_ui_xt_FontImp* self)
{
	if (!imp_vtable_initialized) {
		imp_vtable = *self->imp.vtable;
		imp_vtable.dev_dispose = (psy_ui_font_imp_fp_dispose) psy_ui_xt_font_imp_dispose;		
		imp_vtable.dev_copy = (psy_ui_font_imp_fp_copy) psy_ui_xt_font_imp_copy;
		imp_vtable.dev_fontinfo = (psy_ui_font_imp_fp_dev_fontinfo) dev_fontinfo;
		imp_vtable_initialized = 1;
	}
}

void psy_ui_xt_fontimp_init(psy_ui_xt_FontImp* self, const psy_ui_FontInfo* fontinfo)
{
...
void psy_ui_xt_font_imp_dispose(psy_ui_xt_FontImp* self)
{	
	if (self->hfont) {
...
void psy_ui_xt_font_imp_copy(psy_ui_xt_FontImp* self, psy_ui_xt_FontImp* other)
{				
//	LOGFONT lf;

//	psy_ui_xt_font_imp_dispose(self);
//	GetObject(other->hfont, sizeof(LOGFONT), &lf);
//	self->hfont = CreateFontIndirect(&lf);	
}

psy_ui_FontInfo dev_fontinfo(psy_ui_xt_FontImp* self)
{
	psy_ui_FontInfo rv;
//	int ret;	
//	LOGFONT lf;
