...
// VTable Prototypes
static void dev_dispose(psy_ui_xt_SaveDialogImp*);
static int dev_execute(psy_ui_xt_SaveDialogImp*);
static const char* dev_filename(psy_ui_xt_SaveDialogImp*);

// VTable init
static psy_ui_SaveDialogImpVTable imp_vtable;
static int imp_vtable_initialized = 0;

static void imp_vtable_init(psy_ui_xt_SaveDialogImp* self)
{
...
void psy_ui_xt_savedialogimp_init(psy_ui_xt_SaveDialogImp* self, psy_ui_Component* parent)
{
...
void psy_ui_xt_savedialogimp_init_all(psy_ui_xt_SaveDialogImp* self,
...
void dev_dispose(psy_ui_xt_SaveDialogImp* self)
{
	free(self->title);
	free(self->filter);
...
int dev_execute(psy_ui_xt_SaveDialogImp* self)
{
	int rv = 0;
/*	OPENFILENAME ofn;
...
const char* dev_filename(psy_ui_xt_SaveDialogImp* self)
{
