...
// VTable Prototypes
static void dev_dispose(psy_ui_x11_FontDialogImp*);
static int dev_execute(psy_ui_x11_FontDialogImp*);
static const char* dev_path(psy_ui_x11_FontDialogImp*);
psy_ui_FontInfo dev_fontinfo(psy_ui_x11_FontDialogImp*);
...
static void imp_vtable_init(psy_ui_x11_FontDialogImp* self)
{
...
void psy_ui_x11_fontdialogimp_init(psy_ui_x11_FontDialogImp* self)
{
...
// x11 implementation method for psy_ui_FontDialog
void dev_dispose(psy_ui_x11_FontDialogImp* self)
{
}

int dev_execute(psy_ui_x11_FontDialogImp* self)
{
	int rv;
	//LOGFONT lf;
	//CHOOSEFONT cf;
...
psy_ui_FontInfo dev_fontinfo(psy_ui_x11_FontDialogImp* self)
{
