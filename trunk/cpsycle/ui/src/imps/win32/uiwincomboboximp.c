...
static psy_ui_RealRectangle dev_screenposition(psy_ui_win_ComboBoxImp* self) { return self->win_component_imp.imp.vtable->dev_screenposition(&self->win_component_imp.imp); }
...
static void dev_applyposition(psy_ui_win_ComboBoxImp* self) { self->win_component_imp.imp.vtable->dev_applyposition(&self->win_component_imp.imp); }
...
static bool dev_inputprevented(const psy_ui_win_ComboBoxImp* self) { return self->win_component_imp.imp.vtable->dev_inputprevented(&self->win_component_imp.imp); }
