...
// VTable Prototypes
static void dev_dispose(psy_ui_xt_FontDialogImp*);
static int dev_execute(psy_ui_xt_FontDialogImp*);
static const char* dev_path(psy_ui_xt_FontDialogImp*);
psy_ui_FontInfo dev_fontinfo(psy_ui_xt_FontDialogImp*);
...
static void imp_vtable_init(psy_ui_xt_FontDialogImp* self)
{
...
void psy_ui_xt_fontdialogimp_init(psy_ui_xt_FontDialogImp* self)
{
...
// xt implementation method for psy_ui_FontDialog
void dev_dispose(psy_ui_xt_FontDialogImp* self)
{
}

int dev_execute(psy_ui_xt_FontDialogImp* self)
{
	int rv;
	//LOGFONT lf;
	//CHOOSEFONT cf;
...
psy_ui_FontInfo dev_fontinfo(psy_ui_xt_FontDialogImp* self)
{
