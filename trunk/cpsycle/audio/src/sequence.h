...
void sequenceentry_init(SequenceEntry*, uintptr_t pattern, psy_dsp_big_beat_t offset);
...
INLINE psy_dsp_big_beat_t sequencetrackiterator_offset(SequenceTrackIterator* self)
{
...
SequenceTrackIterator sequence_begin(psy_audio_Sequence*, psy_List* track, psy_dsp_big_beat_t offset);
