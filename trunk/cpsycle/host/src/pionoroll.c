...
{	
	...
	self->zoom = 1.0;
	self->keyblackcolour = psy_ui_color_make(0x00444444);
	self->keywhitecolour = psy_ui_color_make(0x00CACACA);
	self->keyseparatorcolour = psy_ui_color_make(0x00333333);
...
void gridstate_init(GridState* self, PatternViewSkin* skin)
{
	...
	self->zoom = 1.0;
	self->lpb = 4;
	self->eventcolour = psy_ui_color_make(0x00999999);
	self->eventcurrchannelcolour = psy_ui_color_make(0x00CACACA);
	self->eventhovercolour = psy_ui_color_make(0x00DADADA);
	self->grid12separatorcolour = psy_ui_color_make(0x00292929);
	self->gridseparatorcolour = psy_ui_color_make(0x00363636);
	self->playbarcolour = psy_ui_color_make(0x009F7B00);
	self->row4beatcolour = psy_ui_color_make(0x00595959);
	self->row4beat2colour = psy_ui_color_make(0x00595959);
	self->rowbeatcolour = psy_ui_color_make(0x00363636);
	self->rowbeat2colour = psy_ui_color_make(0x00363636);
