...
// TrackerGridState
// prototypes
static void trackergridstate_initinputs(TrackerGridState*);
// implementation
void trackergridstate_init(TrackerGridState* self)
{
	...
	trackergridstate_initinputs(self);
}
...
void trackergridstate_initinputs(TrackerGridState* self)
{
