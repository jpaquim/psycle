...
static void machineviewskin_setcoords(MachineViewSkin*, psy_Properties* p);
// implementation
...
void machineviewskin_settheme(MachineViewSkin* self, psy_Properties* p, const char* skindir)
{
...
void machineviewskin_setcoords(MachineViewSkin* self, psy_Properties* p)
{
	const char* s;
	int vals[4];
