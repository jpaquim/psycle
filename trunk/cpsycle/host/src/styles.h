...
#define STYLE_SEQLISTVIEW_TRACK_SELECT       31054
#define STYLE_SEQLISTVIEW_FOCUS				 31055
#define STYLE_SEQLISTVIEW_ITEM				 31056
#define STYLE_SEQLISTVIEW_ITEM_SELECT        31057
