...
#include <universalis/compiler.hpp>
		...
		#define PSYCLE__CORE__DECL UNIVERSALIS__COMPILER__DYNAMIC_LINK__EXPORT
	#else
		#define PSYCLE__CORE__DECL UNIVERSALIS__COMPILER__DYNAMIC_LINK__IMPORT
	#endif
#else
	#define PSYCLE__CORE__DECL //UNIVERSALIS__COMPILER__DYNAMIC_LINK__HIDDEN
#endif
