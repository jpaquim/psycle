...
#include <universalis/compiler/compiler.hpp>
	...
	#elif UNIVERSALIS__COMPILER__DYNAMIC_LINK == 0 // compat for of packageneric stuff still used in sconscrap, soon to be removed
		#if UNIVERSALIS__COMPILER__CONCATENATED(PACKAGENERIC__MODULE__SOURCE__, UNIVERSALIS__COMPILER__DYNAMIC_LINK) > 0
			#undef  UNIVERSALIS__COMPILER__DYNAMIC_LINK
			#define UNIVERSALIS__COMPILER__DYNAMIC_LINK UNIVERSALIS__COMPILER__DYNAMIC_LINK__EXPORT
		#elif UNIVERSALIS__COMPILER__CONCATENATED(PACKAGENERIC__MODULE__SOURCE__, UNIVERSALIS__COMPILER__DYNAMIC_LINK) < 0
			#undef  UNIVERSALIS__COMPILER__DYNAMIC_LINK
			#define UNIVERSALIS__COMPILER__DYNAMIC_LINK // nothing needed for static link
		#else
			#undef  UNIVERSALIS__COMPILER__DYNAMIC_LINK
