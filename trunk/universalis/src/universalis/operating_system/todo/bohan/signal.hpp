...
#ifndef UNIVERSALIS__OPERATING_SYSTEM__TODO__BOHAN__SIGNAL__INCLUDED
#define UNIVERSALIS__OPERATING_SYSTEM__TODO__BOHAN__SIGNAL__INCLUDED
#pragma once

#include <operating_system/project.hpp>
#include <csignal>

namespace universalis { namespace operating_system { namespace signal {
