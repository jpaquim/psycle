...
#ifndef PSYCLE__CORE__MISC__INCLUDED
#define PSYCLE__CORE__MISC__INCLUDED
#pragma once
...
///\todo not a class, transform it to a namespace
class PSYCLE__CORE__DECL CValueMapper {
	public:
