...
class CMidiInputDlg : public CPropertyPageImpl<CMidiInputDlg>
//class CMidiInputDlg : public CDialogImpl<CMidiInputDlg>
{
// Construction
public:
	CMidiInputDlg();
