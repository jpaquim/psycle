...
[Setup]
AppName=PsycleWTL
AppVerName=Psycle (WTL port version)
AppPublisher=S.F. (Original Version Psycledelics)
AppPublisherURL=http://sfpg.dip.jp/
AppSupportURL=http://sfpg.dip.jp/
AppUpdatesURL=http://sourceforge.jp/projects/psyclewtl/
DefaultDirName={pf}\PsycleWTL
DefaultGroupName=PsycleWTL
Compression=zip/9
OutputDir=C:\My Documents\Visual Studio Projects\PsycleWTL\windowsinstaller\setup
SourceDir=C:\My Documents\Visual Studio Projects\PsycleWTL
DisableStartupPrompt=true
AppCopyright=© Psychedelics 2000-2002 © S.F. 2003-2004
InfoBeforeFile=C:\My Documents\Visual Studio Projects\PsycleWTL\Docs\ReadmeTest.txt
OutputBaseFilename=PsycleWTLInstaller
AllowNoIcons=true
...
UninstallDisplayIcon={app}\PsycleWTL.exe
AppVersion=1.7
...
AppID=PsycleWTL
InfoAfterFile=C:\My Documents\Visual Studio Projects\PsycleWTL\Docs\whatsnew.txt
UninstallDisplayName=Psycle Modular Tracker Studio (WTL Porting Version)
...
[Files]
Source: windowsinstaller\SetupUtils.exe; DestDir: {tmp}; Flags: deleteafterinstall ignoreversion
...
Source: Release\PsycleWTL.exe; DestDir: {app}; Components: Application
Source: AppDll\msvcp71.dll; DestDir: {app}; Components: Application
Source: AppDll\msvcr71.dll; DestDir: {app}; Components: Application
Source: boost_thread-vc71-mt-1_31.dll; DestDir: {app}; Components: Application
Source: 1033\PsycleWTLRes.dll; DestDir: {app}\1033; Components: Application
Source: 1041\PsycleWTLRes.dll; DestDir: {app}\1041; Components: Application
...
Source: Docs\MIDI Input Docs\PsycleMIDIChart.TXT; DestDir: {app}\Docs\MIDI Help; Components: Documents
Source: Docs\MIDI Input Docs\midiconfiguration.jpg; DestDir: {app}\Docs\MIDI Help; Components: Documents
Source: Docs\MIDI Input Docs\midimonitor.jpg; DestDir: {app}\Docs\MIDI Help; Components: Documents
Source: Docs\MIDI Input Docs\midiout.jpg; DestDir: {app}\Docs\MIDI Help; Components: Documents
Source: Docs\MIDI Input Docs\psyclemidi.html; DestDir: {app}\Docs\MIDI Help; Components: Documents
...
Source: Plugins\Arguru\Arguru Synth 2f.prs; DestDir: {app}\Plugins\Arguru; Components: Arguru_Plug-ins; Flags: onlyifdoesntexist
...
Source: Plugins\Druttis\FeedMe.prs; DestDir: {app}\Plugins\Druttis; Components: Druttis_Plug-ins; Flags: onlyifdoesntexist
...
Source: Plugins\Druttis\Phantom.prs; DestDir: {app}\Plugins\Druttis; Components: Druttis_Plug-ins; Flags: onlyifdoesntexist
...
Source: Plugins\Druttis\Sublime.prs; DestDir: {app}\Plugins\Druttis; Components: Druttis_Plug-ins; Flags: onlyifdoesntexist
...
Source: Plugins\Old\Synth22.prs; DestDir: {app}\Plugins\Old; Components: Old_Plug-ins; Flags: onlyifdoesntexist
...
Source: Plugins\Pooplog\Pooplog FM Laboratory.prs; DestDir: {app}\Plugins\Pooplog; Components: Pooplog_Plug-ins; Flags: onlyifdoesntexist
...
Source: Plugins\Pooplog\Pooplog FM UltraLight.prs; DestDir: {app}\Plugins\Pooplog; Components: Pooplog_Plug-ins; Flags: onlyifdoesntexist
...
Source: Plugins\SF\XMSampler\Resources\notekey.png; DestDir: {app}\Plugins\SF\XMSampler\Resources; Components: SF_Plug-ins
Source: Plugins\SF\XMSampler\Resources\sharpkey.png; DestDir: {app}\Plugins\SF\XMSampler\Resources; Components: SF_Plug-ins

[INI]
Filename: {app}\Psycle.url; Section: InternetShortcut; Key: URL; String: http://psycle.project-psy.com; Components: Documents

[Icons]
Name: {userdesktop}\PsycleWTL; Filename: {app}\PsycleWTL.exe; MinVersion: 4,4; Tasks: desktopicon; WorkingDir: {app}; Components: Application
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\PsycleWTL; Filename: {app}\PsycleWTL.exe; MinVersion: 4,4; Tasks: quicklaunchicon; WorkingDir: {app}; Components: Application
Name: {group}\PsycleWTL; Filename: {app}\PsycleWTL.exe; WorkingDir: {app}; Components: Application
Name: {group}\Psycle on the Web; Filename: {app}\Psycle.url; IconIndex: 0; Components: Documents
Name: {group}\Psycle FAQ; Filename: {app}\Docs\FAQ.txt; WorkingDir: {app}\Docs; Components: Documents
...
Name: {group}\Uninstall PsycleWTL; Filename: {uninstallexe}

[Run]
Filename: {app}\PsycleWTL.exe; Description: Launch Psycle; Flags: nowait postinstall skipifsilent; Components: Application
...
Name: {app}\1033; Components: Application
Name: {app}\1041; Components: Application
Name: {app}\Plugins; Components: Sond_Plug-ins Pooplog_Plug-ins Old_Plug-ins Miscellaneous_Plug-ins Druttis_Plug-ins Arguru_Plug-ins SF_Plug-ins
...
Name: {app}\Plugins\SF; Components: SF_Plug-ins
...
Root: HKCR; SubKey: .psf; ValueType: string; ValueData: Psycle Music Archive; Flags: uninsdeletekey
Root: HKCR; SubKey: Psycle Music Archive; ValueType: string; ValueData: Psycle Music Archive; Flags: uninsdeletekey
Root: HKCR; SubKey: Psycle Music Archive\Shell\Open\Command; ValueType: string; ValueData: """{app}\PsycleWTL.exe"" ""%1"""; Flags: uninsdeletevalue
Root: HKCR; Subkey: Psycle Music Archive\DefaultIcon; ValueType: string; ValueData: {app}\PsycleWTL.exe,0; Flags: uninsdeletevalue
...
Name: SF_Plug-ins; Description: S.F. Plugins:XMSampler; ExtraDiskSpaceRequired: 600000; Types: Full
