...
CADriverDialog::CADriverDialog(CWnd* pParent /*=NULL*/)
	: CDialog(CADriverDialog::IDD, pParent)
{
	//{{AFX_DATA_INIT(CADriverDialog)
	m_BufNum = 0;
	m_BufSize = 0;
	m_Device = -1;
	m_Dither = FALSE;
...
void CADriverDialog::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CADriverDialog)
...
BEGIN_MESSAGE_MAP(CADriverDialog, CDialog)
	//{{AFX_MSG_MAP(CADriverDialog)
...
/////////////////////////////////////////////////////////////////////////////
// CADriverDialog message handlers

BOOL CADriverDialog::OnInitDialog() 
{
...
void CADriverDialog::RecalcLatency()
{
	CString str;
...
void CADriverDialog::OnChangeConfigBufnum() 
{
...
void CADriverDialog::OnChangeConfigBufsize() 
{
...
void CADriverDialog::OnSelendokConfigSamplerate() 
{
