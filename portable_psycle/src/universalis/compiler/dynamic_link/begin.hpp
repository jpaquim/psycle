...
#else
	#if UNIVERSALIS__COMPILER__DYNAMIC_LINK || UNIVERSALIS__COMPILER__CONCATENATED__NO_EXPANSION(PACKAGENERIC__MODULE__SOURCE__, UNIVERSALIS__COMPILER__DYNAMIC_LINK)
		#undef  UNIVERSALIS__COMPILER__DYNAMIC_LINK
