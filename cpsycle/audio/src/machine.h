...
void machine_init(psy_audio_Machine*, psy_audio_MachineCallback);
...
INLINE void psy_audio_machine_setcallback(psy_audio_Machine* self, psy_audio_MachineCallback callback)
{
