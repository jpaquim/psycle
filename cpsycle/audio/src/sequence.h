...
psy_audio_SequenceEntryNode* psy_audio_sequence_remove(psy_audio_Sequence*, psy_audio_SequencePosition);
...
void sequence_reposition(psy_audio_Sequence* self, psy_audio_SequenceTrack*);
