...
INLINE void psy_audio_sample_setvibrato(psy_audio_Sample* self,
	psy_audio_Vibrato vibrato)
{
...
INLINE void psy_audio_sample_set_samplerate(psy_audio_Sample* self,
	psy_dsp_big_hz_t samplerate)
{
	self->samplerate = samplerate;
}

INLINE psy_dsp_big_hz_t psy_audio_sample_samplerate(const
