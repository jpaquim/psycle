...
static void psy_ui_x11_g_imp_textout(psy_ui_x11_GraphicsImp*, int x, int y, const char*, size_t len);
static void psy_ui_x11_g_imp_textoutrectangle(psy_ui_x11_GraphicsImp*, int x, int y, unsigned int options,
	psy_ui_Rectangle r, const char* text, size_t len);
static void psy_ui_x11_g_imp_drawrectangle(psy_ui_x11_GraphicsImp*, const psy_ui_Rectangle);
static void psy_ui_x11_g_imp_drawroundrectangle(psy_ui_x11_GraphicsImp*, const psy_ui_Rectangle,
	psy_ui_Size cornersize);
static psy_ui_Size psy_ui_x11_g_imp_textsize(psy_ui_x11_GraphicsImp*, const char*);
static void psy_ui_x11_g_imp_drawsolidrectangle(psy_ui_x11_GraphicsImp*, const psy_ui_Rectangle r,
	psy_ui_Color color);
static void psy_ui_x11_g_imp_drawsolidroundrectangle(psy_ui_x11_GraphicsImp*, const psy_ui_Rectangle r,
	psy_ui_Size cornersize, psy_ui_Color color);
static void psy_ui_x11_g_imp_drawsolidpolygon(psy_ui_x11_GraphicsImp*, psy_ui_IntPoint*,
	unsigned int numpoints, unsigned int inner, unsigned int outter);
static void psy_ui_x11_g_imp_drawline(psy_ui_x11_GraphicsImp*, int x1, int y1, int x2, int y2);
static void psy_ui_x11_g_imp_drawfullbitmap(psy_ui_x11_GraphicsImp*, psy_ui_Bitmap*, int x, int y);
static void psy_ui_x11_g_imp_drawbitmap(psy_ui_x11_GraphicsImp*, psy_ui_Bitmap*, int x, int y, int width,
	int height, int xsrc, int ysrc);
static void psy_ui_x11_g_imp_setbackgroundcolor(psy_ui_x11_GraphicsImp*, psy_ui_Color color);
static void psy_ui_x11_g_imp_setbackgroundmode(psy_ui_x11_GraphicsImp*, unsigned int mode);
static void psy_ui_x11_g_imp_settextcolor(psy_ui_x11_GraphicsImp*, psy_ui_Color color);
static void psy_ui_x11_g_imp_setcolor(psy_ui_x11_GraphicsImp*, psy_ui_Color color);
static void psy_ui_x11_g_imp_setfont(psy_ui_x11_GraphicsImp*, psy_ui_Font* font);
static void psy_ui_x11_g_imp_moveto(psy_ui_x11_GraphicsImp*, psy_ui_IntPoint pt);
static void psy_ui_x11_g_imp_devcurveto(psy_ui_x11_GraphicsImp*, psy_ui_IntPoint control_p1,
...
static void xt_imp_vtable_init(psy_ui_x11_GraphicsImp* self)
{
	if (!xt_imp_vtable_initialized) {
		...
		xt_imp_vtable.dev_dispose = (psy_ui_fp_graphicsimp_dev_dispose)psy_ui_x11_g_imp_dispose;
		xt_imp_vtable.dev_textout = (psy_ui_fp_graphicsimp_dev_textout)psy_ui_x11_g_imp_textout;
		xt_imp_vtable.dev_textoutrectangle = (psy_ui_fp_graphicsimp_dev_textoutrectangle)psy_ui_x11_g_imp_textoutrectangle;
		xt_imp_vtable.dev_drawrectangle = (psy_ui_fp_graphicsimp_dev_drawrectangle)psy_ui_x11_g_imp_drawrectangle;
		xt_imp_vtable.dev_drawroundrectangle = (psy_ui_fp_graphicsimp_dev_drawroundrectangle)psy_ui_x11_g_imp_drawroundrectangle;
		xt_imp_vtable.dev_textsize = (psy_ui_fp_graphicsimp_dev_textsize)psy_ui_x11_g_imp_textsize;
		xt_imp_vtable.dev_drawsolidrectangle = (psy_ui_fp_graphicsimp_dev_drawsolidrectangle)psy_ui_x11_g_imp_drawsolidrectangle;
		xt_imp_vtable.dev_drawsolidroundrectangle = (psy_ui_fp_graphicsimp_dev_drawsolidroundrectangle)psy_ui_x11_g_imp_drawsolidroundrectangle;
		xt_imp_vtable.dev_drawsolidpolygon = (psy_ui_fp_graphicsimp_dev_drawsolidpolygon)psy_ui_x11_g_imp_drawsolidpolygon;
		xt_imp_vtable.dev_drawline = (psy_ui_fp_graphicsimp_dev_drawline)psy_ui_x11_g_imp_drawline;
		xt_imp_vtable.dev_drawfullbitmap = (psy_ui_fp_graphicsimp_dev_drawfullbitmap)psy_ui_x11_g_imp_drawfullbitmap;
		xt_imp_vtable.dev_drawbitmap = (psy_ui_fp_graphicsimp_dev_drawbitmap)psy_ui_x11_g_imp_drawbitmap;
		xt_imp_vtable.dev_setbackgroundcolor = (psy_ui_fp_graphicsimp_dev_setbackgroundcolor)psy_ui_x11_g_imp_setbackgroundcolor;
		xt_imp_vtable.dev_setbackgroundmode = (psy_ui_fp_graphicsimp_dev_setbackgroundmode)psy_ui_x11_g_imp_setbackgroundmode;
		xt_imp_vtable.dev_settextcolor = (psy_ui_fp_graphicsimp_dev_settextcolor)psy_ui_x11_g_imp_settextcolor;
		xt_imp_vtable.dev_setcolor = (psy_ui_fp_graphicsimp_dev_setcolor)psy_ui_x11_g_imp_setcolor;
		xt_imp_vtable.dev_setfont = (psy_ui_fp_graphicsimp_dev_setfont)psy_ui_x11_g_imp_setfont;
		xt_imp_vtable.dev_moveto = (psy_ui_fp_graphicsimp_dev_moveto)psy_ui_x11_g_imp_moveto;
		xt_imp_vtable.dev_curveto = (psy_ui_fp_graphicsimp_dev_curveto)psy_ui_x11_g_imp_devcurveto;
