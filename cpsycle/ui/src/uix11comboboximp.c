...
static psy_ui_TextMetric dev_textmetric(psy_ui_x11_ComboBoxImp* self, psy_ui_Font* font) { return self->x11_component_imp.imp.vtable->dev_textmetric(&self->x11_component_imp.imp, font); }
