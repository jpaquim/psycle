...
static void dev_resize(psy_ui_xt_ListBoxImp* self, int width, int height) { self->xt_component_imp.imp.vtable->dev_resize(&self->xt_component_imp.imp, width, height); }
...
static void dev_setposition(psy_ui_xt_ListBoxImp* self, int x, int y, int width, int height) { self->xt_component_imp.imp.vtable->dev_setposition(&self->xt_component_imp.imp, x, y, width, height); }
