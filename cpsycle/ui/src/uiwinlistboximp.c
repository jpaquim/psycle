...
static const psy_ui_TextMetric* dev_textmetric(psy_ui_win_ListBoxImp* self) { return self->win_component_imp.imp.vtable->dev_textmetric(&self->win_component_imp.imp); }
