...
static void dev_applyposition(psy_ui_win_ListBoxImp* self) { self->win_component_imp.imp.vtable->dev_applyposition(&self->win_component_imp.imp); }
...
static bool dev_inputprevented(const psy_ui_win_ListBoxImp* self) { return self->win_component_imp.imp.vtable->dev_inputprevented(&self->win_component_imp.imp); }
...
static void dev_starttimer(psy_ui_win_ListBoxImp* self, uintptr_t id, uintptr_t interval) { self->win_component_imp.imp.vtable->dev_starttimer(&self->win_component_imp.imp, id, interval); }
static void dev_stoptimer(psy_ui_win_ListBoxImp* self, uintptr_t id) { self->win_component_imp.imp.vtable->dev_stoptimer(&self->win_component_imp.imp, id); }
...
static const psy_ui_TextMetric* dev_textmetric(const psy_ui_win_ListBoxImp* self) { return self->win_component_imp.imp.vtable->dev_textmetric(&self->win_component_imp.imp); }
...
static intptr_t dev_count(psy_ui_win_ListBoxImp* self)
{
	return SendMessage(self->win_component_imp.hwnd, LB_GETCOUNT,
		(WPARAM)0, (LPARAM)0);
}
