...
static void dev_move(psy_ui_x11_EditImp* self, psy_ui_Point origin) { self->x11_component_imp.imp.vtable->dev_move(&self->x11_component_imp.imp, origin); }
...
static psy_ui_RealRectangle dev_position(psy_ui_x11_EditImp* self) { return self->x11_component_imp.imp.vtable->dev_position(&self->x11_component_imp.imp); }
...
static psy_ui_Size dev_size(const psy_ui_x11_EditImp* self) { return self->x11_component_imp.imp.vtable->dev_size(&self->x11_component_imp.imp); }
...
static void dev_invalidaterect(psy_ui_x11_EditImp* self, const psy_ui_RealRectangle* r) { self->x11_component_imp.imp.vtable->dev_invalidaterect(&self->x11_component_imp.imp, r); }
...
static void dev_starttimer(psy_ui_x11_EditImp* self, uintptr_t id, uintptr_t interval) { self->x11_component_imp.imp.vtable->dev_starttimer(&self->x11_component_imp.imp, id, interval); }
...
static const psy_ui_TextMetric* dev_textmetric(const psy_ui_x11_EditImp* self, psy_ui_Font* font) { return self->x11_component_imp.imp.vtable->dev_textmetric(&self->x11_component_imp.imp); }
...
static void dev_setbackgroundcolour(psy_ui_x11_EditImp* self, psy_ui_Colour colour) { self->x11_component_imp.imp.vtable->dev_setbackgroundcolour(&self->x11_component_imp.imp, colour); }
