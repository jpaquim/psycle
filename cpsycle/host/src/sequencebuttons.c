...
{		
	...
	psy_ui_component_set_margin(psy_ui_textinput_base(&self->edit), rowmargin);
...
void sequencebuttons_oneditaccept(SequenceButtons* self, psy_ui_TextInput* sender)
{
...
void sequencebuttons_oneditreject(SequenceButtons* self, psy_ui_TextInput* sender)
{
	psy_ui_component_hide(&self->edit.component);
	psy_ui_component_align(psy_ui_component_parent(&self->component));
	psy_ui_component_invalidate(psy_ui_component_parent(&self->component));
