...
{	
	...
	if (self->instrument) {
		if (self->instrument->dct != psy_audio_DUPECHECK_NONE) {
			psy_ui_component_enableinput(&self->dcacut.component, psy_ui_NONRECURSIVE);
			psy_ui_component_enableinput(&self->dcarelease.component, psy_ui_NONRECURSIVE);
			psy_ui_component_enableinput(&self->dcafadeout.component, psy_ui_NONRECURSIVE);
			psy_ui_component_enableinput(&self->dcanone.component, psy_ui_NONRECURSIVE);
		} else {
			psy_ui_component_preventinput(&self->dcacut.component, psy_ui_NONRECURSIVE);
			psy_ui_component_preventinput(&self->dcarelease.component, psy_ui_NONRECURSIVE);
			psy_ui_component_preventinput(&self->dcafadeout.component, psy_ui_NONRECURSIVE);
			psy_ui_component_preventinput(&self->dcanone.component, psy_ui_NONRECURSIVE);
		}
	}
}
