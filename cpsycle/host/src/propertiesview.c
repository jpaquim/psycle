...
void propertiesview_float(PropertiesView* self, int section, psy_ui_Component* dest)
{
...
void propertiesview_dock(PropertiesView* self, int section, psy_ui_Component* dest)
{
//	if (section == HELPVIEWSECTION_HELP) {
