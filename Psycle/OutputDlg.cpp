...
void COutputDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_MIDI_RECORD_NOTEOFF, m_midiRecordNoteoff);
...
BOOL COutputDlg::OnInitDialog() 
{
	...
	m_midiRecordNoteoff.SetCheck(Global::pConfig->_midiRecordNoteoff?1:0);
...
void COutputDlg::OnOK() 
{
	...
	Global::pConfig->_midiRecordNoteoff = m_midiRecordNoteoff.GetCheck()?true:false;
	CDialog::OnOK();
}
