...
#define CURRENT_FILE_VERSION_MASP	0
#define CURRENT_FILE_VERSION_INSD	0
#define CURRENT_FILE_VERSION_WAVE	0

#define CURRENT_FILE_VERSION		CURRENT_FILE_VERSION_INFO+CURRENT_FILE_VERSION_SNGI+CURRENT_FILE_VERSION_SEQD+CURRENT_FILE_VERSION_PATD+CURRENT_FILE_VERSION_MACD+CURRENT_FILE_VERSION_MASP+CURRENT_FILE_VERSION_INSD+CURRENT_FILE_VERSION_WAVE
