...
namespace psycle
{
	namespace host
	{
		...
		{
			protected:
				port(parent_type &, underlying_type &, real const & x, real const & y);
		};
		...
		namespace ports
		{
			...
			{
				public:
					output(parent_type &, underlying_type &, real const & x, real const & y);
			};
			...
			{
				protected:
					input(parent_type &, underlying_type &, real const & x, real const & y);
			};
			...
			namespace inputs
			{
				...
				{
					public:
						single(parent_type &, underlying_type &, real const & x, real const & y);
				};
				...
				{
					public:
						multiple(parent_type &, underlying_type &, real const & x, real const & y);
				};
			}
		}
		...
		{
			public:
				node(parent_type &, underlying_type &, real const & x, real const & y);
