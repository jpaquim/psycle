	...
	namespace host
	{
		namespace schedulers
		{
			namespace single_threaded
			{
				...
				void graph::on_new_node(graph::underlying_type::node_type & underlying_node)
				{
				}
				...
				void node::on_new_output_port(node::underlying_type::output_port_type & underlying_output_port)
				{
					if(loggers::trace()())
					{
						loggers::trace()("node schedule on new output port underlying", UNIVERSALIS__COMPILER__LOCATION);
					}
				}
				void node::on_new_single_input_port(node::underlying_type::single_input_port_type & underlying_single_input_port)
				{
					if(loggers::trace()())
					{
						loggers::trace()("node schedule on new single input port underlying", UNIVERSALIS__COMPILER__LOCATION);
					}
				}
				void node::on_new_multiple_input_port(node::underlying_type::multiple_input_port_type & underlying_multiple_input_port)
				{
					if(loggers::trace()())
					{
						loggers::trace()("node schedule on new multiple input port underlying", UNIVERSALIS__COMPILER__LOCATION);
					}
				}
				...
				namespace ports
				{
						...
						input_port_count_(underlying.input_ports().size())
					{
						if(loggers::trace()())
						{
							loggers::trace()("new output port schedule", UNIVERSALIS__COMPILER__LOCATION);
						}
						reset();
					}
					...
					namespace inputs
					{
						single::single(single::parent_type & parent, single::underlying_type & underlying) : single_base(parent, underlying)
						{
							if(loggers::trace()())
							{
								loggers::trace()("new single input port schedule", UNIVERSALIS__COMPILER__LOCATION);
							}
						}
						...
						multiple::multiple(multiple::parent_type & parent, multiple::underlying_type & underlying) : multiple_base(parent, underlying)
						{
							if(loggers::trace()())
							{
								loggers::trace()("new multiple input port schedule", UNIVERSALIS__COMPILER__LOCATION);
							}
						}
					}
				}
