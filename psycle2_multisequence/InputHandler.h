...
struct CmdDef
{
	...
	const char * GetName()
	{
		...
		case cdefSequenceDel:	return "Sequence Delete";
...
public:
	...
	// KRISC
	bool EnterDataSeq(UINT nChar,UINT nFlags);
...
public:	
	...
	short oldKeyState;  // used to check when to reset selection SHIFT on change first bit
