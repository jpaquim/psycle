...
class MachineGui : public canvas::Group {
	public:
	...
	protected:
		// helper
		bool InRect(double x, double y, double x1, double y1, double x2, double y2) const;
	...
	private:		
		...
		// selection border
		canvas::Line sel_line_left_top_1;
		canvas::Line sel_line_left_top_2;
		canvas::Line sel_line_right_top_1;
		canvas::Line sel_line_right_top_2;
		canvas::Line sel_line_left_bottom_1;
		canvas::Line sel_line_left_bottom_2;
		canvas::Line sel_line_right_bottom_1;
		canvas::Line sel_line_right_bottom_2;
};		
