		...
		class ITModule2 : public RiffFile
		{
			...
			public:
				...
				*/
				...
				static const std::uint32_t IMPS_ID = 0x49534D49;
				...
				typedef std::pair<std::int8_t, std::int8_t> ITNotePair;
				typedef std::pair<std::int8_t, std::int8_t> ITNodePair1x;
			//	typedef std::pair<std::int16_t, std::int8_t> ITNodePair;
			...
			public:
				...
				struct s3mSampleHeader
				{
					...
					std::uint8_t vol;
					std::uint8_t unused;
					std::uint8_t packed,flags;
					std::uint32_t c2speed;
					std::int32_t unused2,internal,internal2;
					char sName[28];
					/// SCRS
					std::uint32_t tag;
				};
