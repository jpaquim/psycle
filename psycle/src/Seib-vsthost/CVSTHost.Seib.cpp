	...
	namespace vst {
		...
		)
		{
			...
			case audioMasterGetPreviousPlug :
				return GetPreviousPlugIn(nEffect,value);
			case audioMasterGetNextPlug :
				return GetNextPlugIn(nEffect,value);
