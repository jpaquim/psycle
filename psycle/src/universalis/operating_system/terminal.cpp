			...
			#endif
		{
				...
				try
				{
					...
					if(!console_window)
					{
						...
						{
							std::ostringstream s;
							s << "could not allocate a console window: " << operating_system::exceptions::microsoft_code_description();
							throw operating_system::exception(s.str(), UNIVERSALIS__COMPILER__LOCATION);
						}
						allocated_ = true;
					...
					{
						std::ostringstream s;
						s << "could not get a console window: " << operating_system::exceptions::microsoft_code_description();
						throw operating_system::exception(s.str(), UNIVERSALIS__COMPILER__LOCATION);
					}
					...
					if(!operating_system_output) // if we don't have a console attached yet, allocates a console for the operating sytem i/o layer
					{
						...
						{
							std::ostringstream s;
							s << "could not allocate a console at the operating system layer: " << operating_system::exceptions::microsoft_code_description();
							throw operating_system::exception(s.str(), UNIVERSALIS__COMPILER__LOCATION);
						}
						allocated_ = true;
					...
					{
						std::ostringstream s;
						s << "could not allocate a standard output file stream at the operating system layer: " << operating_system::exceptions::microsoft_code_description();
					...
					{
						std::ostringstream s;
						s << "could not allocate a standard error file stream at the operating system layer: " << operating_system::exceptions::microsoft_code_description();
						throw exception(s.str(), UNIVERSALIS__COMPILER__LOCATION);
					}
					...
					{
						std::ostringstream s;
						s << "could not allocate a standard input file stream at the operating system layer: " << operating_system::exceptions::microsoft_code_description();
						throw exception(s.str(), UNIVERSALIS__COMPILER__LOCATION);
					}
