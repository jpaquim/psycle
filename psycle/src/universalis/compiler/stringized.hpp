...
//#namespace UNIVERSALIS
	//#namespace COMPILER
		...
		#define UNIVERSALIS__COMPILER__STRINGIZED(tokens) UNIVERSALIS__COMPILER__STRINGIZED__NO_EXPANSION(tokens)
		...
		#define UNIVERSALIS__COMPILER__STRINGIZED__NO_EXPANSION(tokens) #tokens
	//#endnamespace
//#endnamespace
