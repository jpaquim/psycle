	...
	namespace compiler
	{
		...
		//#namespace DETAIL
			...
			#define UNIVERSALIS__COMPILER__LOCATION__DETAIL(function) \
				...
				PACKAGENERIC__MODULE__NAME  PACKAGENERIC__PACKAGE_META_INFORMATION__VERSION  PACKAGENERIC__MODULE__VERSION \
			...
			///\internal
				...
				#define UNIVERSALIS__COMPILER__LOCATION__DETAIL__FUNCTION + universalis::compiler::typenameof(*this) + UNIVERSALIS__COMPILER__LOCATION__DETAIL__FUNCTION__NO_CLASS
					...
					#define UNIVERSALIS__COMPILER__LOCATION__DETAIL__FUNCTION__NO_CLASS  std::string(__FUNCSIG__)
				#else
