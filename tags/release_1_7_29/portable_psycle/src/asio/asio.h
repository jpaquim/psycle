...
namespace asio
{
	...
	*/
	...
	LIBRARY ASIOError ASIOInit(ASIODriverInfo *info);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOExit(void);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOStart(void);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOStop(void);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOGetChannels(long *numInputChannels, long *numOutputChannels);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOGetLatencies(long *inputLatency, long *outputLatency);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOGetBufferSize(long *minSize, long *maxSize, long *preferredSize, long *granularity);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOCanSampleRate(ASIOSampleRate sampleRate);
	/* Purpose:
		...
		If no input/output is present ASE_NotPresent will be returned.
	*/
	LIBRARY ASIOError ASIOGetSampleRate(ASIOSampleRate *currentRate);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOSetSampleRate(ASIOSampleRate sampleRate);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOGetClockSources(ASIOClockSource *clocks, long *numSources);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOSetClockSource(long index);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOGetSamplePosition (ASIOSamples *sPos, ASIOTimeStamp *tStamp);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOGetChannelInfo(ASIOChannelInfo *info);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOCreateBuffers(ASIOBufferInfo *bufferInfos, long numChannels,
		long bufferSize, ASIOCallbacks *callbacks);
	...
	*/
	...
	LIBRARY ASIOError ASIODisposeBuffers(void);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOControlPanel(void);
	/* Purpose:
	...
	*/
	...
	LIBRARY ASIOError ASIOFuture(long selector, void *params);
	/* Purpose:
		various
		Parameter:
	...
	*/
	...
	LIBRARY ASIOError ASIOOutputReady(void);
	/* Purpose:
