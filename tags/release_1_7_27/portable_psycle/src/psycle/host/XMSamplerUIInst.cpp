// XMSamplerUIInst.cpp : XMSamplerUIInst ÇÃé¿ëï
/** @file
...
//	m_FilterType.AddString(_T("ñ≥Çµ"));
	...
	m_NNA.AddString(_T("Note ∂Øƒ"));
	m_NNA.AddString(_T("Note ÿÿ∞Ω"));
	m_NNA.AddString(_T("ñ≥Çµ"));
...
void XMSamplerUIInst::SetNNACombo(const int nna)
{
	switch(nna)
	{
	case 0:m_NNA.SelectString(0,_T("Note ∂Øƒ"));break;
	case 1:m_NNA.SelectString(0,_T("Note ÿÿ∞Ω"));break;
	case 2:m_NNA.SelectString(0,_T("ñ≥Çµ"));break;
	}
}
