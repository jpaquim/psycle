Installation
------------
1) place ALL dll's to your Psycle\Plugins\Druttis directory.
2) make sure blwtbl.dll is in your main psycle folder (the one containing psycle.exe) or copy it to your windows\system32 (or winnt\system32 directory).
