...
/*****************************************************************************/
/* ImplVSTHost.cpp: CImplVSTHost / CImplEffect implementation                */
...
namespace Seib {
	namespace vsthost {
		...
		{
			CImplEffect *pEffect = (CImplEffect *)GetAt(nEffect);
			if (pEffect)
		...
		void CImplVSTHost::OnMidiIn(CMidiMsg &msg)
		{
		...
		BYTE * CImplVSTHost::CreateMIDIEvents
			(
			int nLength,                        /* # samples                         */
		...
		BYTE * CImplVSTHost::CreateMIDISubset(void *pEvData, unsigned short wChnMask)
		{
			if (!pEvData)
				return NULL;
		...
		void CImplVSTHost::PassThruEffect
			(
			CImplEffect *pEff,                   /* effect to call                    */
		...
		/*===========================================================================*/
		/* CImplEffect class members                                                  */
		/*===========================================================================*/

		/*****************************************************************************/
		/* CImplEffect : constructor                                                  */
		/*****************************************************************************/

		CImplEffect::CImplEffect(CVSTHost *pHost)
			: CEffect(pHost)
		{
			InitializeCriticalSection(&cs);
...
//			pPrev = pNext = NULL;
		...
		/*****************************************************************************/
		/* ~CImplEffect : destructor                                                  */
		/*****************************************************************************/

		CImplEffect::~CImplEffect()
		{
			int i;
		...
		bool CImplEffect::Load(const char *name)
		{
		...
		void * CImplEffect::OnOpenWindow(VstWindow* window)
		{
		...
		bool CImplEffect::OnCloseWindow(VstWindow* window)
		{
		...
		void CImplEffect::OnSizeEditorWindow(long width, long height)
		{
			if (pEditWnd)
		...
		bool CImplEffect::OnUpdateDisplay()
		{
		...
		int CImplEffect::EvalException(int n_except)
		{
		...
		long CImplEffect::EffDispatch(long opCode, long index, long value, void *ptr, float opt)
		{
#if defined(_DEBUG) || defined(_DEBUGFILE)
			switch (opCode)
			{
		...
		bool CImplEffect::OnSetParameterAutomated(long index, float value)
		{
		...
		void CImplEffect::EnterCritical()
		{
		...
		void CImplEffect::LeaveCritical()
		{
		...
		bool CImplEffect::LoadBank(const char *name)
		{
			CFxBank b((char *)name);
			bool brc = false;
