...
// Copyright (C) 2005 Johan Boule: rewritting of the property emulation: using two template-based tricks, one to get the class holding the member functions, and another to support all the operators (thanks to SFINAE).
