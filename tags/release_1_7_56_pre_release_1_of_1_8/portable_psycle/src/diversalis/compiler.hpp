	...
	//#namespace COMPILER
		...
		////////////////////////
			...
			#define DIVERSALIS__COMPILER__FEATURE__AUTO_LINK
				...
				#define DIVERSALIS__COMPILER__VERSION__MINOR 5 /// service pack 5, \todo hardcoded, we should detect this.
				#define DIVERSALIS__COMPILER__VERSION__PATCH 1 /// processor pack after service pack 5, \todo hardcoded, we should detect this.
			#elif _MSC_VER < 1400
...
//#endnamespace
#endif
// arch-tag: d86cb65e-f60a-4940-afc7-cd3ea553cb21
